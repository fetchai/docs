...
This system shows how to integrate the Hugging Face API with an Agentverse Agent. The example consists of multiple layers of Primary and Secondary functions, with the Hugging Face system as the main Primary functions and Hugging Face request and model list as Secondary functions.

### Guide

- [Register a Hugging face API agent as an Agent Function ↗️](/guides/agentverse/huggingface-text-classification-model-agent)
