...
Welcome to your journey into the world of Agents! This example will equip you with the tools to create your very first intelligent Agent using the uAgents Python library.
...
<CodeGroup hasCopy isLocalHostedFile>
    <DocsCode local={true}>
        ...
        async def introduce_agent(ctx: Context):
            ...
            print(f"Hello, I'm agent {ctx.name} and my address is {agent.address}.")
