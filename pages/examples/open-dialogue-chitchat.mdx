...
- [How to use Dialogues 💬↗️](/guides/dialogues/dialogues)
...
## Step 2: Setting up agents
    ...
    - Run `cd ..` to go out of Dialogues directory and create pyhton script `agent1.py`, copy the below script into that.
...
```
    ...
    - Create pyhton script `agent2.py`, copy the below script into that.
...
## Step 3: Run the Dialogue
    ...
    - Start Agent 2:
        ...
        - This agent will automatically attempt to initiate a dialogue by sending an InitiateChitChatDialogue message to Agent 1.
