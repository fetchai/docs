...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agent-secret-api/agent-secret.py) to run this locally.
...
<GithubCodeSegment digest="1f413aedf3fa84835346df1574e18ed2">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agent-secret-api/agent-secret.py"
        lineStart={1}
        lineEnd={27}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='1f413aedf3fa84835346df1574e18ed2'>
