...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/intermediate/agent-and-function-api) to run this locally.
...
<GithubCodeSegment digest="8609f5914b308fc6c450ab9a7825dfeb">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agent-and-function-api/agent.py"
        lineStart={1}
        lineEnd={63}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agent-and-function-api/hosted/agent.py"
        lineStart={1}
        lineEnd={35}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='8609f5914b308fc6c450ab9a7825dfeb'>
...
<GithubCodeSegment digest="95973a181833572c5527b23ed890fd6d">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agent-and-function-api/agent_create.py"
        lineStart={1}
        lineEnd={199}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='95973a181833572c5527b23ed890fd6d'>
