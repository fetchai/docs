...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/advanced/predefined-dialogue-chitchat) to run this locally.
...
<GithubCodeSegment digest="8f26f6f2e5fe73526ceca7964aa8dd8e">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={1}
        lineEnd={6}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='8f26f6f2e5fe73526ceca7964aa8dd8e'>
...
<GithubCodeSegment digest="1cc6efef6a508235ff18e29c0f43900c">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={7}
        lineEnd={22}
...
<GithubCodeSegment digest="2510c8579859a20285609a0f7f58eb1b">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={23}
        lineEnd={51}
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='2510c8579859a20285609a0f7f58eb1b'>
...
<GithubCodeSegment digest="0f54444d0ca314e4d6ae1044bc473858">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={52}
        lineEnd={83}
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='0f54444d0ca314e4d6ae1044bc473858'>
...
<GithubCodeSegment digest="b41de0423911c47868c2becb1c79bb39">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={83}
        lineEnd={109}
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='b41de0423911c47868c2becb1c79bb39'>
...
<GithubCodeSegment digest="9e0ad0665618512c40a358c4df787e71">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={109}
        lineEnd={116}
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='9e0ad0665618512c40a358c4df787e71'>
...
<GithubCodeSegment digest="add2548b39c9dd6cab855ba110308768">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/dialogues/hardcoded_chitchat.py"
        lineStart={117}
        lineEnd={158}
...
<GithubCodeSegment digest="70ab3fc2f42ed9e515e99f5ff2c1f098">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/agent1.py"
        lineStart={1}
        lineEnd={52}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='70ab3fc2f42ed9e515e99f5ff2c1f098'>
...
<GithubCodeSegment digest="17b484acaab2c4ac907ad9ebe9b67ebb">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/advanced/predefined-dialogue-chitchat/agent2.py"
        lineStart={1}
        lineEnd={46}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='17b484acaab2c4ac907ad9ebe9b67ebb'>
