...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/docs_examples/easy/simple-agent-communication-with-bureau/agents_communication.py) to run this locally.
...
<GithubCodeSegment digest="721196287df05b0348844bfefd41a2fd">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/easy/simple-agent-communication-with-bureau/agents_communication.py"
        lineStart={1}
        lineEnd={26}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='721196287df05b0348844bfefd41a2fd'>
