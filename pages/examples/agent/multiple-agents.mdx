...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/multiple-agents/agents.py) to run this locally.
...
<GithubCodeSegment digest="650f839f70eadf2b34c6dd966514576a">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/multiple-agents/agents.py"
        lineStart={1}
        lineEnd={19}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='650f839f70eadf2b34c6dd966514576a'>
