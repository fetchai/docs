...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/examples/easy/create-your-first-agent/agent.py) to run this locally.
...
<GithubCodeSegment digest="66ab6d5e955972cf04d2ffeb0766a43c">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='66ab6d5e955972cf04d2ffeb0766a43c'>
