...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/easy/create-your-first-agent) to run this locally.
...
<GithubCodeSegment digest="154d61cf5761da99b977c060603e9c66">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/easy/create-your-first-agent/local/agent.py"
        lineStart={1}
        lineEnd={15}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/easy/create-your-first-agent/hosted/agent.py"
        lineStart={1}
        lineEnd={7}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='154d61cf5761da99b977c060603e9c66'>
