...
<GithubCodeSegment digest="f3fa0311d5d2c3a974acf758de51a654">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agents-with-docker/src/agent.py"
        lineStart={1}
        lineEnd={69}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='f3fa0311d5d2c3a974acf758de51a654'>
...
<GithubCodeSegment digest="61164fb5ac7fa26cf68665d401fc19cc">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agents-with-docker/Dockerfile"
        lineStart={1}
        lineEnd={12}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='61164fb5ac7fa26cf68665d401fc19cc'>
...
<GithubCodeSegment digest="c5968d7a0aa277e98151fb92b7a98a78">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/agents-with-docker/docker-compose.yml"
        lineStart={1}
        lineEnd={11}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='c5968d7a0aa277e98151fb92b7a98a78'>
