...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/intermediate/table-booking-demo) to run this locally.
...
<GithubCodeSegment digest="c3c5863868afc297576cfd7face5f5fc">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/protocols/query.py"
        lineStart={1}
        lineEnd={51}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/hosted/query.py"
        lineStart={1}
        lineEnd={51}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='c3c5863868afc297576cfd7face5f5fc'>
...
<GithubCodeSegment digest="05d69de7843daf0fcc22f004388bf173">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/protocols/book.py"
        lineStart={1}
        lineEnd={34}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/hosted/book.py"
        lineStart={1}
        lineEnd={35}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='05d69de7843daf0fcc22f004388bf173'>
...
<GithubCodeSegment digest="61dbc094974ca310966c4e04afe278c9">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/restaurant.py"
        lineStart={1}
        lineEnd={29}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/hosted/restaurant.py"
        lineStart={1}
        lineEnd={17}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='61dbc094974ca310966c4e04afe278c9'>
...
<GithubCodeSegment digest="cf26dd5dcaa150d6e872e45e8dbc52b3">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/user.py"
        lineStart={1}
        lineEnd={65}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/table-booking-demo/hosted/user.py"
        lineStart={1}
        lineEnd={52}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='cf26dd5dcaa150d6e872e45e8dbc52b3'>
