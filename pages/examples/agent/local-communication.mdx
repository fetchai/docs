...
<GithubCodeSegment digest="f0f958fe26918f1100eb2e1a2cf98a1d">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/easy/local-communication/agent_1.py"
        lineStart={1}
        lineEnd={23}
        hosted={true}
    />
...
<GithubCodeSegment digest="2d389e050795854fd37df916b3c9bacb">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/easy/local-communication/agent_2.py"
        lineStart={1}
        lineEnd={26}
        hosted={true}
    />
