...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/docs_examples/intermediate/send-tokens-agents/local-sending_tokens.py) to run this locally.
...
<GithubCodeSegment digest="d74246360203e6d70f5286dc083d8c83">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/send-tokens-agents/local-sending_tokens.py"
        lineStart={1}
        lineEnd={58}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='d74246360203e6d70f5286dc083d8c83'>
