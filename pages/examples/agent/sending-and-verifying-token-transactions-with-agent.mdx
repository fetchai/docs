...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/sending-and-verifying-token-transactions-with-agent/web3/transaction.py) to run this locally.
