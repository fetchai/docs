...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/docs_examples/intermediate/sending-and-verifying-token-transactions-with-agent/web3/transaction.py) to run this locally.
...
<GithubCodeSegment digest="ec74ce141c974af83c9b2ec8a020bc29">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/sending-and-verifying-token-transactions-with-agent/web3/transaction.py"
        lineStart={1}
        lineEnd={191}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='ec74ce141c974af83c9b2ec8a020bc29'>
