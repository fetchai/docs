...
This example showcases how to use Agents to analyze a startup idea by performing market research, technological assessments, and business planning. It employs two different systems: uAgents (for agent-based communication) and crew_ai (for task-driven collaboration).
