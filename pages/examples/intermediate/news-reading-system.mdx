...
<GithubCodeSegment digest="10bfcb93ee9f780df2254b353ee8d4f1">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/news-reading-system/news-reading-agent/agent.py"
        lineStart={1}
        lineEnd={52}
        hosted={true}
    />
...
<GithubCodeSegment digest="bd2d994b81fd692ad6b5ad9dbe1b3964">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/news-reading-system/news-generating-agent/agent.py"
        lineStart={1}
        lineEnd={74}
        hosted={true}
    />
...
<GithubCodeSegment digest="ea2666feb7278f73fab5036dfa257327">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/news-reading-system/generate-categorical-news/agent.py"
        lineStart={1}
        lineEnd={78}
        hosted={true}
    />
...
<GithubCodeSegment digest="1606347885239c5e4c9e72312855657f">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/news-reading-system/generate-regional-news/agent.py"
        lineStart={1}
        lineEnd={92}
        hosted={true}
    />
...
<GithubCodeSegment digest="9512ef2da7135a55e1393e42e27a392f">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/news-reading-system/generate-keyword-news/agent.py"
        lineStart={1}
        lineEnd={77}
        hosted={true}
    />
