...
This example creates a shopping assistant agent using FastAPI and uagents. The agent handles shopping questions, uses the OpenAI API to generate responses, and sends personalized shopping advice back to the user. The `on_query` method is key to processing and responding to these queries.
...
```bash
{"response":"That's great! MacBooks are known for their sleek design and powerful performance. Here are a few options for you:\n\n1. MacBook Air: This is a great choice if you're looking for something lightweight and portable. It comes with a 13.3-inch retina display and is powered by Apple's M1 chip. The MacBook Air has up to 18 hours of battery life and comes with 256GB or 512GB of SSD storage.\n\n2. MacBook Pro: If you're a professional needing more power and features, this is the MacBook for you. It comes in two sizes; 13-inch and 16-inch, both powered by Apple's M1 chip. The MacBook Pro has a brighter Retina display than the Air,"}
```

 - Shopping Assistance Agent

```
INFO:     [Shopping Assistant]: Received message from user1dg9tc03zc5n8fk0dlkrjpqeuehpa8gz8xtx832safvnljgvrlk4s0qsl9e with question: i want to purchase a macbook
INFO:     [Shopping Assistant]: Question: i want to purchase a macbook
Answer: That's a great choice! MacBooks are known for their high-quality performance, sleek design, and excellent customer service. Here are a few options for you:

1. MacBook Air: This is a lightweight and portable option. It has a 13.3" Retina display, and comes with the new M1 chip from Apple, which increases its performance and battery life. 

2. MacBook Pro: This is a larger and more powerful option. It's available in two sizes, 13.3" and 16". The 13.3" model also comes with the M1 chip, while the 16" model has Intel processors. The MacBook Pro is great if you do a lot of heavy computing tasks like video editing or
```
