...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/verify-messages/message_verification.py) to run this locally.
...
<GithubCodeSegment digest="61fd20532834d65883ef86a73d708f4c">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/verify-messages/message_verification.py"
        lineStart={1}
        lineEnd={58}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='61fd20532834d65883ef86a73d708f4c'>
