...
<CodeGroup hasCopy isLocalHostedFile>
   ...
   ```python copy filename="local-news_agent.py"
   ...
   ```
    ...
    ```python copy filename="hosted-news_agent.py"
   # Import Required libraries
   import requests
   from uagents import Agent, Context, Model
...
<CodeGroup hasCopy isLocalHostedFile>
      ...
      ```python copy filename="local-webscraper_agent.py"
      # Import Required libraries
      import requests
      import aiohttp
      from uagents import Agent, Context, Model
...
<CodeGroup hasCopy isLocalHostedFile>
      ...
      ```python copy filename="local-sentiment_agent.py"
      # Import Required libraries
      import requests
      from uagents import Agent, Context, Model
      from uagents.setup import fund_agent_if_low
