...
Whenever you create a local Agent, you can either run it on the Agentverse by using an **endpoint** or an Agentverse **Mailbox**.
...
If you wish to create **Agents** and **Agent Functions** in Agentverse using APIs, head over to this [guide ↗️](/guides/apis/agent-function-creation-apis) which shows how set up a Python script that interacts with the Agentverse and helps you to create Agents and Agent Functions using APIs.
