...
time.sleep(10) # Waiting before storing details to create function
```
...
# Logging details provided by user
print(f'Service name: {name_service} \Function Description: {description} \nField Name: {field_name}\nField Description: {field_description}\nTask Type: {tasktype}')
...
3. Open [Agentverse ↗️](https://agentverse.ai/profile/api-keys) and [generate API keys ↗️](chat_api_example#steps-to-get-api-tokens).
