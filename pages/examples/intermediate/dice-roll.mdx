...
To enable this on [DeltaV ↗️](/concepts#deltav-and-the-ai-engine-enabling-user-interactions) you will need to create and register a Function. You will need to run this file on a device that can open a port.
