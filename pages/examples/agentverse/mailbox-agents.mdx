...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/mailbox-agents/agent_1.py) to run this locally.
...
<GithubCodeSegment digest="e2ac21d4601877fc395bff52db418a00">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='e2ac21d4601877fc395bff52db418a00'>
