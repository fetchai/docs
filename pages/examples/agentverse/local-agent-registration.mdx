...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/1-uagents/docs_examples/intermediate/local-agent-registration) to run this locally.
...
<GithubCodeSegment digest="711f429a8d26b083ec6d48678be2e4ea">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/local-agent-registration/local/agent.py"
        lineStart={1}
        lineEnd={36}
        hosted={true}
    />
	<CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/1-uagents/examples/intermediate/local-agent-registration/hosted/agent.py"
        lineStart={1}
        lineEnd={23}
        hosted={false}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='711f429a8d26b083ec6d48678be2e4ea'>
