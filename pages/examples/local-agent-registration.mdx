...
This file can be run on any platform supporting Python, with the necessary install permissions. This example shows one local agent registered as a service on the Agentverse and which can be queried on [DeltaV ↗️](/concepts/ai-engine/deltav).
