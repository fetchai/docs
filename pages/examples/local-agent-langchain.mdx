...
For this step, head to this [guide ↗️](/guides/agents/locally-running-langchain-integration#register-your-agent-function-on-the-agentverse) for a detailed overview of the registration process.
