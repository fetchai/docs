...
## Steps to add secret to agent using API
    ...
    - Open [Agentverse ↗️](https://agentverse.ai/profile/api-keys) and [generate API keys](chat_api_example#steps-to-get-api-tokens).
    - Open script in editor and replace `access_token` and `refresh_token`.
