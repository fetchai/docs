...
- Create a python file `chitchat.py` in `Dialogues` directory.
    ...
    <CustomPre 
        commands={{
        windows: `echo. > chitchat.py`,
        mac: `touch chitchat.py`,
        ubuntu: `touch chitchat.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
- Run `cd ..` to go out of `Dialogues` directory and create `agent1.py` Python script
    ...
    <CustomPre 
        commands={{
        windows: `echo. > agent1.py`,
        mac: `touch agent1.py`,
        ubuntu: `touch agent1.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
- Create Python `agent2.py` script:
    ...
    <CustomPre
        commands={{
        windows: `echo. > agent2.py`,
        mac: `touch agent2.py`,
        ubuntu: `touch agent2.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
