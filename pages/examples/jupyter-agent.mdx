...
Please check out the example code in our [examples repo ↗️](https://github.com/fetchai/uAgent-Examples/tree/main/5-helpers/jupyter-notebook) to run this locally.
...
<GithubCodeSegment digest="">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/6-helpers/jupyter-notebook/agent_in_notebook.ipynb"
        lineStart={1}
        lineEnd={223}
        hosted={true}
    />
