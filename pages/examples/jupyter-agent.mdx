...
Jupyter notebook natively supports asyncio, and as uAgents are asynchronous by design, Jupyter and agents work together with ease.

Please check out the example code in our [examples repo](https://github.com/fetchai/uAgent-Examples/tree/main/5-documentation/jupyter-notebook) to run this locally.

## Installation

We're using [poetry]() to manage our application, not super essestial for you. Just be sure to have the following libaries installed:
...
Are you new to agents? To understand the agent in this example, please read [communicating with agents](/guides/agents/intermediate/communicating-with-other-agents)
...
INFO:     [jupyter_test_agent]: Almanac contract registration is up to date!
