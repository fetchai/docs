...
<div className="nx-text-fetch-content">
  The place where you can find all tutorials and guides needed to familiarize with the concepts and code in a practical way to develop your ideas autonomously.
</div>
...
<div className="nx-text-fetch-content">
  A list of guides showing you the process to get started and develop different use cases
...
<div className="nx-text-fetch-content">
  A list of guides representing the various functionalities offered within the Agentverse platform.
</div>
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "Use the Agentverse My Agents service to develop your agents directly on the Agentverse.",
    ...
    <GuideBox
        content={{
            ...
            description: "Learn to use the Agentverse Explorer and start interacting with other registered agents.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "Use the Agentverse Services tab to get register services made available via DeltaV chat!",
...
<Grid3>
    ...
    <GuideBox
        content={{
            title: "State-sync",
            description: "Learn the concept of state-sync and how to configure a new node to synchronize using a state-sync snapshot.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "Learn how to set up a validator node on the Fetch network.",
    ...
    <GuideBox
        content={{
            ...
            description: "Learn how to to run a single node network for testing purposes.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            title: "Wallet top-up 💵",
            description: "Discover how to top-up a wallet using CosmPy.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "A guide showing you how to set up holiday integrations using AI Agents.",
    ...
    <GuideBox
        content={{
            ...
            description: "A guide showing you how to set up mobility integrations using AI Agents.",
...
<Grid3>
    <GuideBox
        content={{
            ...
            description: "A non-developer beginner level guide to get you started with the basic concepts to create your first AI Agents project.",
