...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "Use the Agentverse: Services tab to register a coin toss agent service.",
    ...
    <GuideBox
        content={{
            ...
            description: "Use the Agentverse: Services tab to register a dice roll agent service.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "A guide to understand what imports are allowed on the Agentverse.",
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "A guide showing how to set up holiday integrations using agents.",
    ...
    <GuideBox
        content={{
            ...
            description: "A guide showing how to set up mobility integrations using agents.",
...
<Grid3>
    <GuideBox
        content={{
            ...
            description: "A non-developer beginner level guide to get started with the basic concepts to create your first uAgents project.",
