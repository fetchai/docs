...
<Grid3>
    ...
    <GuideBox
        content={{
            title: "Local AI Agents and Agentverse Services registration",
            description: "Register you locally run agents and their services on the Agentverse and DeltaV!",
            path: "/guides/agents/running-locally"
        }}
    />
