...
<Grid3>
    ...
    <GuideBox
        content={{
            title: "Create and register a service on DeltaV 🌐️",
            description: "A guide showing how to register your service on DeltaV.",
            path: "/guides/deltav/create-and-get-a-service-on-deltav"
        }}
    />
