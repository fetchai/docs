...
<div className="nx-text-fetch-content">
  Discover DeltaV revolutionary interface and how to execute different services queries using its interface.
</div>
...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            description: "A guide showing how find top destinations and activities using DeltaV chat interface.",
