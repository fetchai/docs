...
<Grid3>
    ...
    <GuideBox 
        content={{
            ...
            description: "Understand the concept of name service and how it applies to Agents.",
    ...
    <GuideBox 
        content={{
            title: "On_query Decorator",
            description: "Understand the concept of on_query decorator and how it applies to Agents.",
            path: "/guides/agents/on-query"
        }}
    />
...
<Grid3>
    ...
    <GuideBox
        content={{
            title: "Agents for AI 101 🤖️",
            description: "A non-developer beginner level guide to get you started wit the AI Engine, Agentverse Services and DeltaV.",
