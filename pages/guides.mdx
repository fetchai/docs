...
<GuideMdx  content={ [
  ...
  },
  {
    ...
    data: [
      {
        title: "Fetch Mobile Wallet: Get Started",
        description: "A guide showing how to get started with Fetch Mobile Wallet functionalities.",
      ...
      {
        title: "How to stake with Fetch Mobile Wallet",
        description: "A guide showing how to stake using the Fetch Mobile wallet.",
  ...
  },
  {
    ...
    data: [
      {
        title: "Ledger: Installation",
        description: "Install and get started with fetch.",
