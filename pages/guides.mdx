...
<Grid3>
    ...
    <GuideBox
        content={{
            ...
            path: "/guides/ledger/cli/multisig-keys"
        }}
    />
    ...
    <GuideBox
        content={{
            ...
            path: "/guides/ledger/cli/delegator"
        }}
    />
    ...
    <GuideBox
        content={{
            ...
            path: "/guides/ledger/cli/governance-proposals"
        }}
    />
