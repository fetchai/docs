...
<GuidesMdx content={ [
  ...
  },
  {
    ...
    icon: AgentverseIcon,
    description:
      "A list of guides representing the various features offered within the Agentverse.",
    data: [
      {
        title: "Creating an Agentverse hosted Agents",
        description:
          "Use the Agentverse: My Agents tab to develop Agents directly on Agentverse.",
        path: "/guides/agentverse/creating-a-hosted-agent",
      },
      {
        title: "Utilizing the Agentverse Mailroom service",
        description:
          "Set up Agentverse Mailboxes for your local Agents and to run them independently of your constant presence to run the server.",
      ...
      },
      {
        ...
        description:
          ...
          "A guide to understand what imports are allowed on the Agentverse.",
  ...
  },
  {
    ...
    data: [
      {
        title: "AVCTL",
        description: "A guide to use CLI to perform Agents related actions on Agentverse.",
    ...
    data: [
      {
        ...
        description: "A guide to convert Native FET to and from ERC-20 FET.",
      ...
      },
      {
        ...
        description: "A guide showing different ways one can stake FET.",
        path: "/guides/fetch-network/different-ways-to-stake-the-fet-token"
      },
      {
        title: "Re-delegating staked FET token",
        description: "A guide showing the steps to complete re-delegation successfully.",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description: "Learn to manage your tokens using CLI.",
        path: "/guides/fetch-network/ledger/cli/tokens"
      },
      {
        title: "CLI - Multisig keys",
        description: "Learn to create multi signature keys using CLI.",
      ...
      },
      {
        ...
        description: "Learn to create a governance proposal using CLI.",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description: "A guide to use CosmPy to connect to blockchains.",
        path: "/guides/fetch-network/cosmpy/establishing-node-connection"
      },
      {
        title: "Querying balances",
        description: "A guide to use CosmPy to query balances related to an address.",
        path: "/guides/fetch-network/cosmpy/querying-address-balances"
      },
      {
        title: "Wallets and private keys",
        description: "A guide to use CosmPy to create wallets and private keys.",
        path: "/guides/fetch-network/cosmpy/creating-wallet"
      },
      {
        title: "Sending funds",
        description: "A guide to use CosmPy to send funds.",
        path: "/guides/fetch-network/cosmpy/transaction-broadcast"
      },
      {
        title: "Staking with CosmPy",
        description: "A guide to use CosmPy to stake your tokens.",
