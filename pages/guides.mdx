...
<GuideMdx  content={ [
  {
    ...
    description:
      ...
      "A list of guides showing the process to get started and develop use cases using uAgents technology.",
    data: [
      {
      ...
      },
      {
        ...
        description: "Build your first uAgent in a matter of few steps.",
      ...
      {
        title: "uAgents address",
        description:
          "A guide to understand how to retrieve an uAgent's addresses.",
        path: "/guides/agents/getting-uagent-address",
      },
      {
        title: "Using uAgents storage function",
        description:
          "A guide to understand how to call and use uAgents' storage functions.",
      ...
      },
      {
        ...
        description:
          "A guide showing how to use uAgents to send tokens with one another.",
      ...
      },
      {
        ...
        description:
          ...
          "A guide showing how to use uAgents to broadcast messages using protocols.",
        path: "/guides/agents/broadcast",
      },
      {
        title: "Dialogues",
        description:
          "Understand the concept of dialogues and how it applies to uAgents.",
  ...
  },
  {
    ...
    data: [
      {
        title: "Creating an Agentverse hosted uAgent",
        description:
          "Use the Agentverse: My Agents tab to develop uAgents directly on the Agentverse platform.",
        path: "/guides/agentverse/creating-a-hosted-agent",
      },
      {
        title: "Utilizing the Agentverse Mailroom service",
        description:
          "Set up Agentverse mailboxes for your locally-run uAgents and to run them independently of your constant presence to run the server.",
        path: "/guides/agentverse/utilising-the-mailbox",
      },
      {
        title: "Agentverse Functions: register uAgent Functions on the Agentverse",
        description:

          "Use the Agentverse to register uAgent Functions retrievable by the AI Engine.",
  ...
  },
  {
    ...
    data: [
      {
        title: "AVCTL",
        description: "A guide for using CLI to perform uAgents related actions on Agentverse.",
  ...
  },
  {
    ...
    data: [
      {
        title: "uAgents 101",
        description: "A non-developer beginner level guide to get you started with the basic concepts to create your first uAgents project.",
        path: "/guides/agent-courses/introductory-course"
      },
      {
        title: "uAgents 101 for AI Engine",
