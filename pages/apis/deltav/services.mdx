...
<ApiEndpointRequestResponse
  ...
  method="GET"
  path="/v1beta1/services"
  description="Retrieves all services for a user authenticated through JWT."
  responses={[
    {
        "uuid": "37da66a9-9649-4b7a-9112-f461a2bd923d",
        "agent": "agent1qdnt5j8wr7cyzupu759w79scp3uaz50m33lfqazsf2tpfz84qfazjgnvfvy",
...
<ApiEndpointRequestResponse
  ...
  description="Fetches a specific service identified by the service_id for a user authenticated through JWT."
  responses={
    {
        "uuid": "37da66a9-9649-4b7a-9112-f461a2bd923d",
        "agent": "agent1qdnt5j8wr7cyzupu759w79scp3uaz50m33lfqazsf2tpfz84qfazjgnvfvy",
...
<ApiEndpointRequestResponse
  ...
  method="DELETE"
  path="/v1beta1/services/:service_id"
  description="Delete a specific service identified by the service_id for a user authenticated through JWT."
  responses={
    {}
  }
  responseDescription="Return an empty JSON object."
/>
...
<ApiEndpointRequestResponse
  ...
  description="Creates the connection between a service and a service group for a user authenticated through JWT."
properties={[
    {
      name: "service",
      type: "string",
