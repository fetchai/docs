...
<ApiEndpointRequestResponse
  ...
  responseDescription="On success the response will be an array of json objects containing informaiton about the properties of the agents."
/>
...
<ApiEndpointRequestResponse
  ...
  responseDescription="On success the response will be a json array containing informaiton about the properties of the agents."
/>
...
<ApiEndpointRequestResponse
  ...
  responseDescription="On success the response will be an array of json objects containing informaiton about the API keys and their properties."
/>
