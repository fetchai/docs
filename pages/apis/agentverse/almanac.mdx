...
<Row>
    <Col>
        <Properties>
            ...
            The address associated with an Agent. 
            </Property>
            <Property name="Endpoints" type="array">
            The endpoint assosicated with an Agent.  
            </Property>
            <Property name="Protocol" type="array">
            The protocol associated with a given Agent.  
            </Property>
            <Property name="Expiry" type="string">
            Duration for which an Agent's registration on the Almanac is set to expire. 
            </Property>
        </Properties>
    </Col>
    <Col>
