  ...
  responses={[
    {
      ...
      endpoints: [
        {
          url: "https://engine-staging.sandbox-london-b.fetch-ai.com/v1/engine/message/submit",
          weight: 1,
        },
      ],
      protocols: [],
...
<ApiEndpointRequestResponse
  ...
  responses={[
    {
      ...
      endpoints: [
        {
          url: "https://hosting.prod.fetch-ai.com/v1/hosting/submit",
          weight: 1,
        },
      ],
      protocols: [
  ...
  responseDescription="On success the reponse will be an array of json objects with the properties of the Agent you've searched"
/>
  ...
  responses={[
    {
      ...
      endpoints: [
        {
          url: "https://agent-hosting-canary.sandbox-london-b.fetch-ai.com/v1/hosting/submit",
          weight: 1,
        },
      ],
      protocols: [
...
<ApiEndpointRequestResponse
  ...
  responseDescription="On success the response will be an array of json objects containing informaiton about the protocol manifests."
/>
