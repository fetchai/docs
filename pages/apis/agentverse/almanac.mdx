...
<Row>
    <Col>
         <ApiIntro>
             On success, the response will be a json array with the informaiton about the recently registered Agents. 
         </ApiIntro>
    </Col>
    <Col>
        <Tabs>
...
<Row>
    <Col>
         <ApiIntro>
             On success the reponse will be a json array with the recently registered agents.
         </ApiIntro>
    </Col>
    <Col>
        <Tabs>
...
<Row>
    <Col>
         <ApiIntro>
             On success, the reponse will be a json array with the information for the agent specified by address. 
         </ApiIntro>
    </Col>
    <Col>
        <Tabs>
...
<Row>
    <Col>
         <ApiIntro>
             On success the response will be json array with information about the availability of a name. 
         </ApiIntro>
    </Col>
    <Col>
        <Tabs>
...
<Row>
    <Col>
         <ApiIntro>
             On success the response will be a json array with the needed information. 
         </ApiIntro>
    </Col>
    <Col>
        <Tabs>
