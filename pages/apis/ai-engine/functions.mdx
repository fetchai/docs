...
<ApiEndpointRequestResponse
  ...
  responseDescription="Returns a list of FunctionMinimal objects associated with the user"
/>
...
<ApiEndpointRequestResponse
  ...
  responseDescription="Returns a function identified by a specific function_id."
/>
...
<ApiEndpointRequestResponse
  ...
  method="PUT"
  path="/v1beta1/functions"
  description="Update a function of a user authenticated through JWT."
  properties={[
    {
      name: "uuid",
      type: "string",
      description:
        "uuid of function in UUID4 format.",
    },
    {
      name: "agent",
      type: "string",
  ...
  responseDescription="Returns the updated function object"
/>
...
## Ask for review of a function

<ApiEndpointRequestResponse
  apiUrl="https://engine-staging.sandbox-london-b.fetch-ai.com"
  method="PUT"
  path="/v1beta1/functions/ask-review/{function_id}"
  description="Ask for review of a specific function (identified by the function_id) of a user authenticated through JWT."
  responses={
    {
        "uuid": "37da66a9-9649-4b7a-9112-f461a2bd923d",
        "agent": "agent1qdnt5j8wr7cyzupu759w79scp3uaz50m33lfqazsf2tpfz84qfazjgnvfvy",
  ...
  pathParameters={{function_id:"your_function_id",}}
  responseDescription="Returns the function object (identified by function_id) that we have just submitted for review."
/>
