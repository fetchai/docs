...
<ApiEndpointRequestResponse
  ...
  description="Un-publish a specific function (identified by the function_id) of a user authenticated through JWT."
  responses={
    {
        "uuid": "37da66a9-9649-4b7a-9112-f461a2bd923d",
        "agent": "agent1qdnt5j8wr7cyzupu759w79scp3uaz50m33lfqazsf2tpfz84qfazjgnvfvy",
  ...
  pathParameters={{function_id:"your_function_id",}}
  responseDescription="Returns the function object (identified by function_id) which was just unpublished."
/>
