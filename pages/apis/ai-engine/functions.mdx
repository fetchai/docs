...
## Change status of a function

<ApiEndpointRequestResponse
  apiUrl="https://engine-staging.sandbox-london-b.fetch-ai.com"
  method="POST"
  path="/v1beta1/functions"
  description="Change status of a function belonging to a user authenticated through JWT."
properties={[
    {
      name: "uuid",
      type: "string",
    ...
    },
    {
      ...
      type: "string",
      description:
        "The new status. Can be 'testing' or 'in-review'",
    }
  ]}
  samplePayload={{
    "uuid": "c9a34239-84ea-48a5-a54b-ca7da6410662",
    "status": "testing"
  }}
  responses={
    {
  ...
  responseDescription="Returns the modified Function object"
/>
