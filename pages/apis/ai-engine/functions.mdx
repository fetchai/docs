...
<Row>
    ...
    <Col>
        ...
        DELETE /v1beta1/functions/delete-from-function-group/:function_id/:function_group_id/
        ```
    </Col>
...
## Delete function from function group

<ApiEndpointRequestResponse
  apiUrl="https://engine-staging.sandbox-london-b.fetch-ai.com"
  method="DELETE"
  path="/v1beta1/delete-from-function-group/{function_id}/{function_group_id}/"
  description="Delete a function of a user (authenticated through JWT) from a function group."
  pathParameters={{function_id:"your_function_id", function_group_id:"your_function_group_id"}}
  responses={
    {}
  }
