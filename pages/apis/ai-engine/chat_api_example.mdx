...
To get better understanding of the workflow how User, deltaV and AI-engine work collectivly to achieve user object please refer [Powering connections and smart operations in DeltaV ↗️](https://fetch.ai/docs/concepts/ai-engine/powering-connections-and-smart-operations-in-deltav).
