...
<Row>
    <Col>
        The DeltaV API allows you to interact with the DeltaV backend, allowing you to interact with your agents and more.
    </Col>
    <Col>
        ```bash filename="Endpoints"
        GET /v1/engine/chat/sessions
        POST /v1/engine/chat/sessions

        DELETE /v1/engine/chat/sessions/:session_id

        POST /v1/engine/chat/sessions/:session_id/submit

        GET /v1/engine/chat/sessions/:session_id/responses

        GET /v1/engine/chat/sessions/:session_id/messages

        GET /v1/engine/chat/sessions/:session_id/messages/all

        POST /v1/engine/chat/sessions/:session_id/feedback

        GET /v1/engine/chat/remaining_tokens
        ```
    </Col>
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="POST"
  path="/v1/engine/chat/sessions/:session_id/submit"
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="DELETE"
  path="/v1/engine/chat/sessions/:session_id"
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="GET"
  path="/v1/engine/chat/sessions/:session_id/responses"
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="GET"
  path="/v1/engine/chat/sessions/:session_id/messages?from_timestamp=2023-08-31T13:26:30.941865"
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="GET"
  path="/v1/engine/chat/sessions/:session_id/messages/all"
  description="Fetches agent messages filtered by timestamps for a specific session identified by the session_id"
  responses={[
    {
      session_id: "063fcfef-a3ec-46c4-aa8e-c9a51b6f24b7",
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="POST"
  path="/v1/engine/chat/sessions/:session_id/feedback"
...
<ApiEndpointRequestResponse
  apiUrl="engine-canary.sandbox-london-b.fetch-ai.com"
  method="POST"
  path="/v1/engine/chat/remaining_tokens?models=talkative-01,creative-01&email=user@user.com"
