...
<Grid2>
    ...
    <GuideBox
        content={{
            title: "Endpoints",
            description: "Endpoints are essential for remote communication between uAgents.",
...
<div className="nx-text-fetch-content">
  An overview of the constituting elements of the uagents Framework needed to carry out effectively tasks and communications between uAgents.
</div>
