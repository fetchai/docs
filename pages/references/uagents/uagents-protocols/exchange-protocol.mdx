...
By adhering to the Agents Exchange Protocol, Agents within the Fetch.ai Agents ecosystem can communicate with each other using a standardized and interoperable method.

    <Callout type="info" emoji="ℹ️">
      The protocol establishes a common format and structure for messages, enabling seamless interaction and integration between different Agents and Functions.
    </Callout>
...
Envelopes are then JSON encoded and sent to endpoints of other Agents or Functions.
