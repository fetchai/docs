...
The [How to book a table at a restaurant using agents ↗️](/guides/agents/booking-demo) and the [How to use the agents to simulate a cleaning scenario ✨ ↗️](/guides/agents/cleaning-demo) guides in the [Agents guides ↗️](/guides#agents) section, instead, shows a more complex and real-world demonstrations making use of the agent's storage concept.
