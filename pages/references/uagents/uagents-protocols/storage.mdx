...
The [How to book a table at a restaurant using uAgents ↗️](/guides/agents/booking-demo.md) guide in the uAgents guides section, instead, shows a more complex and real-world demonstration making use of the uAgent's storage to store a table information in a restaurant.
