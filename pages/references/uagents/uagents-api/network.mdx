...
A class representing the Almanac contract for uAgent registration.

This class provides methods to interact with the Almanac contract, including
checking if an uAgent is registered, retrieving the expiry height of an uAgent's
registration, and getting the endpoints associated with an uAgent's registration.
...
Check if an uAgent is registered in the Almanac contract.

**Arguments**:

- `address` _str_ - The uAgent's address.
  

**Returns**:

- `bool` - True if the uAgent is registered, False otherwise.
...
Get the expiry height of an uAgent's registration.
...
- `int` - The expiry height of the uAgent's registration.
...
Get the endpoints associated with an uAgent's registration.
...
- `Any` - The endpoints associated with the uAgent's registration.
...
Get the protocols associated with an uAgent's registration.
...
- `Any` - The protocols associated with the uAgent's registration.
...
Register an uAgent with the Almanac contract.

**Arguments**:

- `ledger` _LedgerClient_ - The Ledger client.
- `wallet` _LocalWallet_ - The uAgent's wallet.
- `agent_address` _str_ - The uAgent's address.
- `protocols` _List[str]_ - List of protocols.
- `endpoints` _List[Dict[str, Any]]_ - List of endpoint dictionaries.
- `signature` _str_ - The uAgent's signature.
...
Get the uAgent's sequence number for Almanac registration.
...
- `int` - The uAgent's sequence number.
...
- `agent_address` _str_ - The address of the uAgent.
...
- `ledger` _LedgerClient_ - The Ledger client.
- `wallet` _LocalWallet_ - The wallet of the uAgent.
- `agent_address` _str_ - The address of the uAgent.
- `name` _str_ - The name to be registered.
- `domain` _str_ - The domain in which the name is registered.
