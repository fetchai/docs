...
The Protocol class encapsulates a particular set of functionalities for an uAgent.
It typically relates to the exchange of messages between uAgents for executing some task.
