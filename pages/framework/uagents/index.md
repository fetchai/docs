...
- **easy to learn**: follow our quick start guides to [install](quickstart/installation.md) the Python package and [create an agent](quickstart/run-agent.md) in just a few minutes.
- **customizable**: create any type of agent you can think of and put into code.
- **connected**: on startup, each agent automatically joins the fast growing network of μAgents by registering on the [Almanac](key-concepts/Alamanac contract/almanac-overview.md), a smart contract deployed on the Fetch.ai blockchain.
