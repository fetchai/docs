...
3. Create the table query to generate the **QueryTableRequest** using the **restaurant** address. If the request has not been completed before, we send the request to the restaurant agent.
