...
{
    type: 'DeltaV',
    title: "Agentverse Services: register a coin toss function on DeltaV",
    description: "An example for a coin toss agent function available on DeltaV.",
    path: "/examples/coin-toss",
},
{
    type: 'DeltaV',
    title: "Agentverse Services: register a dice roll function on DeltaV",
    description: "An example for a dice roll agent function available on DeltaV.",
    path: "/examples/dice-roll",
},
{
    type: "DeltaV", 
    title: "Agentverse Services: register a local agent as a function",
...
},
{
...
},
   {
    ...
    description: "An example on how to use AI-Engines chat APIs.",
