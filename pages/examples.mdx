...
{
    type: "Agents", 
    title: "Query an Agents using a proxy API",
    description: "An example showing how to query an Agents using a proxy API.",
...
},
{
    ...
    description: "An example for a local Agent registered as a function available on DeltaV.",
...
},
{
   ...
   {
    type: 'Agentverse API',
    title: "Agent and Function Creation using APIs",
