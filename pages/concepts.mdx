...
Fetch.ai is developing a platform to enable the development of an AI empowered agent based decentralized digital economy. This economy is built by agents, Agents are programs that can make choices on their own for individuals, companies, and devices. Agents are the 'doers' of Fetch.ai ecosystem.
