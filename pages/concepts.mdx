...
<Grid2>
    ...
    <GuideBox
        content={{
            ...
            description: "Explore the integration of AI Engine within DeltaV, enabling connections between users and agent-based services.",
...
<Grid2>
    ...
    <GuideBox
        content={{
            title: "DeltaV",
            description: "Introducing DeltaV chat.",
