...
<div className="nx-text-fetch-content">
  Get to know Fetch.ai, the tools and the goals it is aiming for!
</div>

<Grid2>
    <GuideBox
        content={{
            title: "Introducing Fetch.ai: pioneering a decentralized digital economy",
            description: "An overview of Fetch.ai goals and tools.",
