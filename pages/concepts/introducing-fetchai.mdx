...
Agents are built with the  **uAgents Framework**, a lightweight library designed to facilitate the development of decentralized **Agents**. At the core of the uAgents Framework there is an open sourced communication protocol for Agents.
