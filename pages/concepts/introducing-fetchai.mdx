...
The Fetch.ai network is composed of multiple essential elements; at the networks core is the _Almanac contract_, the _Fetch Name Service_, the _Fetch ledger_, and the _FET Token_. These web3 componenets are essential for a decentralised network for AI agents, and enable an easier path to developing your ideas and solutions and making them discoverable to a wider audience.
