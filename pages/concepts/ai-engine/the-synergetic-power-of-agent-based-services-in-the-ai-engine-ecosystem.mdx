...
The AI Engine allows users and developers to connect to a wide range of agent-based services. Once an agent is [registered ↗️](/guides/agentverse/registering-agent-services) the service provided is visible to the AI engine and it can start connecting users and services together.
