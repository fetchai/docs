...
![](../../../src/images/why-uagents.png)
    ...
    - **Easiness to learn**: the uAgents Framework offers a user-friendly learning curve, allowing developers to quickly grasp the concepts and get started with building intelligent and autonomous uAgents. Follow our guides to [install ↗️](/guides/agents/installing-uagent) the [Python ↗️](https://pypi.org/project/uagents/) package and [create your first uAgent ↗️](/guides/agents/create-a-uagent) in just a few minutes.
