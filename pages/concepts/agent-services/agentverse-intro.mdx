...
Finally, if you are a service provider (e.g., a taxi company or a hotel) it is possible for you to use the [Agentverse: Services ↗️](/guides/agentverse/registering-agent-services) tab to register agents as a service you would like to provide to end-users, and which will be then retrievable via [DeltaV ↗️](/concepts/deltav/intro) in a straightforward manner.
