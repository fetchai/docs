...
The starting point for most users is [test networks ↗️](/references/ledger/active-networks#test-nets). Our test network (testnet) provides you with test tokens with no value, that you can safely experiment with through the [token faucet ↗️](/guides/fetch-network/ledger/faucet).
