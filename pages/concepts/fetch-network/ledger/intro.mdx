...
A **ledger**, within blockchain technology, refers to a decentralized and distributed digital book that records all transactions across a network. This is used to ensure transparency and security of transactions and operations undertaken on that network.
...
The starting point for most users is [our test network ↗️](/references/fetch-network/ledger/active-networks#test-nets). Our testnet provides you with test tokens with no value, that you can safely experiment with through the [faucet ↗️](/guides/fetch-network/ledger/faucet).
