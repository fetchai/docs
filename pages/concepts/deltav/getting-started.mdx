...
Kickstart your journey with this groundbreaking technology by navigating towards [DeltaV ↗️](https://deltav.agentverse.ai/login) and **sign in** using your account. You have the option to sign in with either your **Google account** or [**Fetch Wallet** ↗️](/guides/fetch-network/fetch-wallet/fetch-wallet-getting-started).
...
<Callout type="info" emoji="ℹ️">
  Location sharing is necessary if you are interacting with DeltaV. For instance, if you are looking for ride-sharing or flights services, DeltaV will require your location to provide precise options and estimates based on your current whereabouts, such as the nearest available vehicle or airport available.
</Callout>
