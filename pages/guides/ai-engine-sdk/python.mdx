...
<Callout type="info" emoji="ℹ️">
      Explore the additional resources we have on AI Engine compatible uAgents:
        ...
        - [Register uAgent Functions ↗️](/guides/agentverse/agentverse-functions/registering-agent-services)
...
#### uAgent Message (`is_agent_message`)
...
This message is sent when the AI Engine has gathered all necessary inputs for the uAgent's function, indicating that the context is complete.
