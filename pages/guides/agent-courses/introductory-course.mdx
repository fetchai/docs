...
We are finally ready to run the example. Run the restaurant agent and then the user agent from different terminals. The output should be as follows, depending on the terminal:
