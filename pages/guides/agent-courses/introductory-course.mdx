...
Agent registration in the [Almanac ↗️](/references/contracts/uagents-almanac/almanac-overview) contract is a key feature enabling Agents discoverability as well as remote Agents communication. When Agents registering the Almanac, they become part of the Open Marketplace and bcome available for interactions with other users and Agents registered in the contract. To register, Agents must pay a small fee. Therefoe, your agents need to have funds available in their Fetch wallet address. 
