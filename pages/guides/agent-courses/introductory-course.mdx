...
Agent registration in the [Almanac ↗️](/references/contracts/uagents-almanac/almanac-overview) contract is a key feature which enables discoverability of Agents as well enabled remote Agents communication. To register, Agents must pay a small fee. Therefore your agents need to have funds available in their Fetch wallet address. 
...
Now, it's time to put your newfound skills to work. We invite you to delve deeper into the world of Agents by exploring our dedicated [Agents ↗️](/guides/agents/getting-started/whats-an-agent) documentation and [GitHub ↗️](https://github.com/fetchai/uAgents) repository. Also, do not forget to checkout our full list of [Agents guides ↗️](/guides) diving into the development of Agents and concepts explained in this introductory course, but in a more detailed manner.

Once you get familiar with the uAgents Framework toolset for Agents development, you can then get started and start building your first [Agent Function ↗️](/guides/agents/intermediate/agent-functions). To get to know Functions and how to register them on Agentverse to make them discoverable to other Agents and the AI Engine, then have a look at our dedicated resources, including:

    - [Agent Function ↗️](/guides/agents/intermediate/agent-functions)
