...
Let's build the `restaurant` agent from above protocols and set the table availability information, also to storing the `TABLES` information in the `restaurant` agent's storage:
