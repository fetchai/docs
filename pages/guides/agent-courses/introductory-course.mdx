...
This course guides you through your first AI Agent development journey. As you move on, you will be able to create increasingly complex agents and use cases. This guide is aimed at beginner programmers, but it contains a lot of information for experienced developers too. If you are unsure about certain terms or topics, contact us on [Discord ↗️] (https://discord.gg/fetchai).

## Introduction to AI agents

The [uAgents Framework ↗️](/concepts/agents/agents) is a lightweight framework that enables individuals and organizations to create and deploy AI Agents in a variety of contexts, including decentralized contexts. **AI Agents** are programs designed to operate freely in a decentralized landscape based on the user's goals. AI Agents can connect, search and transact to create dynamic markets. They can be programmed with logic to interact with their environment and with other agents in the network to perform operations without human involvement. Agents enable individuals and businesses to automate a wide range of workflows by combining artificial intelligence, API calls, blockchain technology and sophisticated business logic.
...
The [uAgents Framework ↗️](https://pypi.org/project/uagents/) is the fundamental infrastructure in Fetch.ai's ecosystem for the creation and deployment of AI Agents. It serves as a base framework providing the tools, protocols and functionalities necessary for the development of autonomous agents. The Framework is integrated with several key components of the Fetch.ai ecosystem, including the [AI Engine ↗️](/concepts/ai-engine/ai-engine-intro), the [Almanac contract ↗️](/references/contracts/uagents-almanac/almanac-overview) and the [Agentverse ↗️](/concepts/agent-services/agentverse-intro), which is a cloud-based platform providing developers with a single environment for developing, managing and deploying AI Agents.

### Key concepts

#### Addresses

AI Agents developed with the uAgents Framework are identified by **two types of addresses** (these serve as identifiers for each agent within the Fetch.ai Ecosystem):
...
AI Agents can store information in **JSON files** that they can freely retrieve when needed. **Storage** is critical for agents to maintain state, remember past interactions and make informed decisions based on historical data.
