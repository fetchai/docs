...
Setups are the initial hurdle of any software endeavor. We were once new to programming, just like you. Because we know what a challenge it can be, do reach out to us on our [Discord ↗️](https://discord.gg/fetchai) where a team member will assist you.

    <Callout type="info" emoji="ℹ️">
      This guide primarily uses the python programming language [Python ↗️](https://www.python.org/downloads/) there are plenty of programming languages out there, but we think python is particulary good to learn with, but also build great to build AI agents with too.
    </Callout>
...
Now we've got all our necessary tools installed, let's create your working directory and initalise poetry 🎉
...
If you're happy with the install location for the project, let's go ahead an initalise poetry.
...
As previously specified, the uAgents Framework is a Python library designed for creating intelligent and autonomous agents in decentralized environments. It prioritizes security through cryptography for message and asset protection. It enables easy collaboration between agents in distributed networks via the [Almanac contract ↗](https://fetch.ai/docs/references/contracts/uagents-almanac/almanac-overview). Agents find applications in various domains and fields, including:
...
If you're new to JSON please see an example [here ↗️](https://www.w3schools.com/whatis/whatis_json.asp)
