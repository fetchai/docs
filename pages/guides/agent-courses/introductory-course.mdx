...
Creating your first agent is a straightforward process. First of all, we need to create a Python file for this example. We can do this by running: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > alice_agent.py`,
        mac: `touch alice_agent.py`,
        ubuntu: `touch alice_agent.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Let's create a new Python file for these agents: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > duo_agent.py`,
        mac: `touch duo_agent.py`,
        ubuntu: `touch duo_agent.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Let's create a new script for this example:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > agent_communication.py`,
        mac: `touch agent_communication.py`,
        ubuntu: `touch agent_communication.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Let's create a Python script for this example:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > almanac_registration.py`,
        mac: `touch almanac_registration.py`,
        ubuntu: `touch almanac_registration.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
We can start with `alice` agent. Let's create a Python script for it:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > remote_alice.py`,
        mac: `touch remote_alice.py`,
        ubuntu: `touch remote_alice.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Similarly, we need to define a script for `bob` so to create a remote communication with `alice` agent. Let's create a Python script for it: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > remote_bob.py`,
        mac: `touch remote_bob.py`,
        ubuntu: `touch remote_bob.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
We first create the Python file containing the script. Run: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > storage.py`,
        mac: `touch storage.py`,
        ubuntu: `touch storage.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
