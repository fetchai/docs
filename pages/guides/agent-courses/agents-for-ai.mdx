...
In a nutshell, AI Engine indexes Agents, and translates human input into **tasks**. It may sound like a search engine, but it does much more.

![The AI Engine has an internal database hat creates understanding and links to existing Agent Functions](../../../src/images/guides/101/ai-connects.jpg)
...
Let's go to [Agentverse ↗️](https://agentverse.ai/mailroom) and create a Mailbox for this agent.
...
This one is quite simple, but we are defining this as a Secondary Function. A Secondary Function tells the AI Engine that this function should only be called to support another agent, and not as a primary response. You can learn more about this in our [services guide ↗️](guides/services/services#primary-and-secondary-functions)
...
that must be generated from another secondary function.
