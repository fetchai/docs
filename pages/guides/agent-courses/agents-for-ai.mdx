...
This one is quite simple, but we are defining this as a subtask. A subtask tells AI engine that this function should only be called to support another agent, and not as a primary response. You can learn more about this in our [services guide ↗️](guides/services/services#tasks-and-subtasks)
