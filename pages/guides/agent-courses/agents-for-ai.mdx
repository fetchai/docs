...
build agents to be accessible to the AI-Engine, and integrate with other projects.
...
Let's try and keep this really simple 🎉
 ...
 - deltaV - deltav is a assistive chat interface to allow human input to interact with agents registered with deltaV.
...
engine, but does more.
 ...
 IMAGE: AI-Engine with links to agents which are offering a service
...
This could be more complicated, what if every sensor on a car was an agent, you could ask you car for
...
I think this is best explained with ...

Okay, bear with me. Some new terms.

![](../../../src/images/guides/system.svg)

## Let's build a couple of agents
