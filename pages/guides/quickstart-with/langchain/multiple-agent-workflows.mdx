...
In this example, we are hard coding the agents addresses, meaning we know them. To search for agents dynamically, take a look at the [Almanac ↗️](/references/contracts/uagents-almanac/almanac-overview).
