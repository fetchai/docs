...
Fetch.ai creates a dynamic communication layer that allows you to abstract away components into individual [agents ↗️](/guides/agents/getting-started/whats-an-agent). At Fetch.ao, our Agents are micro-services that are programmed to communicate with other agents, and or humans. Other frameworks make agents too, in this case we're looking at CrewAI to see how fetch.ai and CrewAI can benefit each other.
