...
Agents can communicate remotely by also using the [Agentverse ↗️](/concepts/agent-services/agentverse-intro). The Agentverse is a platform that aims at creating a decentralized network of agents capable of communicating and interacting with each other. Agents in the Agentverse can send and receive messages, execute tasks, and collaborate with other agents to achieve various goals.
