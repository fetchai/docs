...
3. Let's define our uAgents, `alice` and `bob`. Ensure they have enough funds in their wallets to carry out transactions.
...
4. We can now define our uAgents functions.
