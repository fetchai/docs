...
1. First of all, create a Python script and name it:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > uagent-address.py`,
        mac: `touch uagent-address.py`,
        ubuntu: `touch uagent-address.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
1. Let's create a Python script, and name it: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > fetch-address.py`,
        mac: `touch fetch-address.py`,
        ubuntu: `touch fetch-address.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
1. First of all, you need to create a Python script and name it: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > my_agent.py`,
        mac: `touch my_agent.py`,
        ubuntu: `touch my_agent.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
