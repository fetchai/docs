...
1. First of all, create a Python script and name it: `uagent-address.py`
...
1. Let's create a Python script, and name it: `fetch-address.py`
...
1. First of all, you need to create a Python script and name it: `my_agent.py`
...
On your terminal, run the script: `my_agent.py`
