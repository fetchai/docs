...
Let's create a very basic Agent to get started. Here below you can finde the most basic Agent application; we want the Agent to perform a task periodically.
