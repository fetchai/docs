...
Create a new Python script:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > interval_task.py`,
        mac: `touch interval_task.py`,
        ubuntu: `touch interval_task.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Create a new Python script:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > simple_example.py`,
        mac: `touch simple_example.py`,
        ubuntu: `touch simple_example.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
