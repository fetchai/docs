import {CodeGroup, CodeSegment} from "../../../components/code";
 import { GithubCodeSegment } from "../../../components/code";
...
<GithubCodeSegment>
    <CodeSegment
        path="https://github.com/fetchai/uAgents/blob/main/python/examples/01-first-agent/main.py"
        lineStart={1}
        lineEnd={9}
        last_updated={""}
        hosted={true}
...
<CodeGroup dynamic hasCopy isLocalHostedFile>
...
<CodeGroup hasCopy isLocalHostedFile>
    ...
    <CodeOption filename="" local =true>
