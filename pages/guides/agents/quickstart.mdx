...
<GithubCodeSegment digest="123ef85c91c1d5307fe7a3326d354af0">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='123ef85c91c1d5307fe7a3326d354af0'>
...
Excellent! You are now ready to start exploring the concepts and resources available to start developing your Agents on the Fetch Network! if you're keen to skip the more code focused guides, your best next steps would be [Communicating with other Agents](intermediate/communicating-with-other-agents).
