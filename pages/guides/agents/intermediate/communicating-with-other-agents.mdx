...
2. Let's now create our agent, `sigmar`, by providing `name`, `seed`, `port`, and `endpoint`. **Make sure it has enough funds to register in the Almanac contract**:

<<<<<<< HEAD
<GithubCodeSegment digest="598aad236207cb6c05691940d16f705d">
=======
<GithubCodeSegment digest="18b0a8b3adee413ce50a3de150def57f">
>>>>>>> e929acddacbc6928624845fda41b0fbc4e3a7701
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/5-documentation/guides/agents/intermediate/communicating-with-other-agents/remote_agents_sigmar.py"
        lineStart={8}
        lineEnd={13}
