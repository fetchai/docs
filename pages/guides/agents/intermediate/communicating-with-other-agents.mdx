...
1. First of all, let's create a Python script for this task:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > agents_communication.py`,
        mac: `touch agents_communication.py`,
        ubuntu: `touch agents_communication.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
The first step would be to create two different Python scripts for this task, each one representing a remote agent:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > remote_agents_slaanesh.py`,
        mac: `touch remote_agents_slaanesh.py`,
        ubuntu: `touch remote_agents_slaanesh.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
    ...
    <CustomPre 
        commands={{
        windows: `echo. > remote_agents_sigmar.py`,
        mac: `touch remote_agents_sigmar.py`,
        ubuntu: `touch remote_agents_sigmar.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
