...
Go to [AgentVerse ↗️](https://agentverse.ai/) and create new fucntion for all three agents created [above ↗️](/guides/agents/intermediate/huggingface-text-classification-model-agent#setting-up-agents).
...
![](../../../../src/images/guides/agentverse/Hugging-Face-System/Hugging-Face-System-2.png)
    ...
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [Hugging face system agent ↗️](/guides/agents/intermediate/primary-secondary-functions#setting-up-agents).
