# Utilise a Hugging face API to create a multi agent pipeline

## Introduction

It's time to build an example of secondary functions in use. Secondary function []()
...
Go to [AgentVerse Services ↗️](https://agentverse.ai/services) and create new services for all three agents created
[above ↗️](/guides/agents/intermediate/huggingface-text-classification-model-agent#setting-up-agents).
...
![](../../../../src/images/guides/agentverse/Hugging-Face-System/Hugging-Face-System-2.png)
    ...
    - **Description**: super important to be as detailed as you can, as reasoning AI Engine looks at descriptions to understand what your service does - in this example we can specify something like this: **This service helps user to give any query to the selected model and gets the response to their query. Always go for hugging face request subtask for this task.**
                        **Subtask chronology**
    ...
    - **Task type**: task.
    - **Protocol**, **Model** will be automatically populated based on the source code of [Hugging face system agent ↗️](/guides/agents/intermediate/primary-secondary-functions#setting-up-agents).
...
![](../../../../src/images/guides/agentverse/Hugging-Face-System/Hugging-Face-Request-2.png)
    ...
    - **Task type**: subtask.
    - **Protocol**, **Model** will be automatically populated based on the source code of [Hugging face system agent ↗️](/guides/agents/intermediate/primary-secondary-functions#hugging-face-request-agent).
...
![](../../../../src/images/guides/agentverse/Hugging-Face-System/Model-List-2.png)
    ...
    - **Task type**: subtask.
    - **Protocol**, **Model** will be automatically populated based on the source code of [Hugging face system agent ↗️](/guides/agents/intermediate/primary-secondary-functions#model-list-agent)
...
Hugging Face subtask will initiate Model Lists subtask and ask for **Search keyword** for which you want to search the models for.
