...
You will need to provide the **local agent address** and make sure it is running on your terminal as only running agents can enroll Agent Functions on the Agentverse!
   ...
   <Callout type="warning" emoji="⚠️">
     If you see a message saying "We couldn't find this agent address on Fetch Network" you will need to wait for some time (around 5 minutes) until the protocols are uploaded successfully and your agent is retrievable.
   </Callout>
...
You can now test your agent on DeltaV!
