...
# Make your agents AI Engine compatible
 ...
 In the previous example ([Agent functions](/guides/agents/intermediate/agent-functions)) we created a simple agent that
 returned a dice roll, however this agent was already ready to be callable by AI Engine. Let's get into how.
