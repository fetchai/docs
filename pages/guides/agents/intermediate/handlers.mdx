...
1. Let's create a Python script for this task, and name it:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > interval-task.py`,
        mac: `touch interval-task.py`,
        ubuntu: `touch interval-task.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
1. First of all, let's create a Python script for this task, and name it: `broadcast.py`
    ...
    <CustomPre 
        commands={{
        windows: `echo. > broadcast.py`,
        mac: `touch broadcast.py`,
        ubuntu: `touch broadcast.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
2. Create a Python script name `on_query.py` by running:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > on_query.py`,
        mac: `touch on_query.py`,
        ubuntu: `touch on_query.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
