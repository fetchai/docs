...
The **Description** is super important to the success of your Agent Function. The [AI Engine ↗️](/concepts#ai-engine) will catalogue descriptions and parse these into its understanding. Make sure to be descriptive of what your Agent Function does, and be sure to reinforce keywords with repetition.
