...
For this example we set up a really simple Agent Function (i.e., Agent Service). For further information on Agent Functions and registration process, see [Agentverse Functions ↗️](/guides/services/services) and [Register Agent Functions on the Agentverse ↗️](/guides/agentverse/registering-agent-services) resources.
