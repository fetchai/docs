...
<GithubCodeSegment digest="f2ae5fbab17b1ec85a4099f1769e4a34">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/5-documentation/guides/agents/intermediate/langchain-rag-agent/src/messages/requests.py"
        lineStart={1}
        lineEnd={7}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='f2ae5fbab17b1ec85a4099f1769e4a34'>
...
<GithubCodeSegment digest="d9f0c828050b47fc75c7019283ec5f69">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/5-documentation/guides/agents/intermediate/langchain-rag-agent/src/agents/langchain_rag_agent.py"
        lineStart={1}
        lineEnd={137}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='d9f0c828050b47fc75c7019283ec5f69'>
...
<GithubCodeSegment digest="fa2e5f46a9335d8f7bf84c6f6f3d5162">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/5-documentation/guides/agents/intermediate/langchain-rag-agent/src/agents/langchain_rag_user.py"
        lineStart={1}
        lineEnd={41}
        hosted={true}
    />
</GithubCodeSegment>
<CodeGroup dynamic hasCopy isLocalHostedFile digest='fa2e5f46a9335d8f7bf84c6f6f3d5162'>
...
<GithubCodeSegment digest="b0d529c9d92b8c2a0392459e5e904c1c">
    <CodeSegment
        path="https://github.com/fetchai/uAgent-Examples/blob/main/5-documentation/guides/agents/intermediate/langchain-rag-agent/src/main.py"
        lineStart={1}
        lineEnd={11}
        hosted={true}
    />
