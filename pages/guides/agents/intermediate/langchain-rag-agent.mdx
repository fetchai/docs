...
The script for this agent looks as follows:
    ...
    <Callout type="warning" emoji="⚠️">
      Remember that you need to provide the `name`, `seed`, `mailbox`, `LANGCHAIN_RAG_SEED` and `AGENT_MAILBOX_KEY` parameters to correctly run this example.
    </Callout>
...
The script looks as follows:
    ...
    <Callout type="warning" emoji="⚠️">
      Remember that you need to provide the `QUESTION`, `URL`, `DEEP_READ`, `RAG_AGENT_ADDRESS`, `name`, `seed`  and `endpoint` parameters to correctly run this example.
    </Callout>
