...
<GithubCodeSegment digest="d8fcf4b9769b9ddb42a3334613ddc41c">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='d8fcf4b9769b9ddb42a3334613ddc41c'>
...
```
    ...
    **Ensure the agent has sufficient funds to operate**.
...
<GithubCodeSegment digest="2e2c8a970f5234e67a105952c88f7630">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='2e2c8a970f5234e67a105952c88f7630'>
...
```
    ...
    We are now ready to define the User Agent. We create the `langchain_rag_user` is created with a specific `port` and `endpoint`, which is where it will communicate with the RAG Agent. **Make sure the agent's enough funds in the wallet to operate**.
