...
1. First of all naviage to directory where you want to make your project.
2. Create a python script name `on_query.py` using `touch on_query.py`.
...
4. Create `agent_query` function to send query to agent and decode the response recieved.
