...
- Script 1:
    ...
    ```
    WARNING:  [looper]: No endpoints provided. Skipping registration: Agent won't be reachable.
    ...
    INFO:     [looper]: Attaching the agent or bureau to the external loop...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: >>> Looper is shutting down.
    ```
...
- Script 2:
    ...
    WARNING:  [looper]: No endpoints provided. Skipping registration: Agent won't be reachable.
    INFO:     [looper]: >>> Looper is starting up.
    INFO:     [looper]: Agent inspector available at https://agentverse.ai/inspect/?uri=http%3A//127.0.0.1%3A8001&address=agent1qwep424538eh7fcruqcnx8la3q3tgl4tgksrcdtahqs7dqgs4rewsx4jefu
    INFO:     [looper]: Starting server on http://0.0.0.0:8001 (Press CTRL+C to quit)
    INFO:     [looper]: Starting the external loop from the agent or bureau...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: Doing hard work...
    INFO:     [looper]: >>> Looper is shutting down.
