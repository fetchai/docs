...
First of all, let's create a Python script:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > external_loop_attach.py`,
        mac: `touch external_loop_attach.py`,
        ubuntu: `touch external_loop_attach.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
Let's start by creating a Python script:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > external_loop_run.py`,
        mac: `touch external_loop_run.py`,
        ubuntu: `touch external_loop_run.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
