...
### News Reading Details Secondary function
    ...
    - **Fucntion title**: just the name of your service; in this example let's call it **News Reading details**.
...
### Generate Categorical News 
    ...
    - **Application**: Secondary function.
    - **Protocol** and **Data Model** will be automatically populated based on the source code of [your generate categorical agent ↗️](/guides/agents/advanced/utilizing-api-to-build-network-of-task-and-subtask#generate
 -categorical-news).
    - **Field descriptions**:
...
Subtask **News Reading Details Secondary function** will be triggered once we select **News Reading URL System** and it will provide options as mentioned in field description for **News Reading Secondary Function**.
