...
The [Almanac ↗️](/references/contracts/uagents-almanac/almanac-overview) contract requires Agents to register using their **uAgent Address** and pay a fee for registration to be found by other Agents on the network.
