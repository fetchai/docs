...
Using `on_message` handler, the agent takes the ether account address and returns the latest transaction on Ethereum blockchain to  DeltaV agent for that address.
