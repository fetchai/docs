...
We also want to define 2 specific **protocols**, one for table querying (i.e., **Table querying protocol**) and one for table booking (i.e., **Table booking protocol**). Then we will need to define two μAgents scripts, **restaurant** and **user**, which will make use of the protocols to query and book a table.
...
3. After having defined our protocols, we will create 2 scripts, one for our **restaurant** and the other one for **user** uAgents. These μAgents will make use of the protocols to query, check, confirm and book an available table at the restaurant.
