# Communicating with other μAgents 📱🤖
## Introduction
...
In this guide, we want to show how to enable remote communications between μAgents using the [Agentverse Mailbox Service ↗️](/guides/agentverse/utilising-the-mailbox.mdx)️.
