...
Once you've [installed ↗️](/guides/agents/installing-uagent)️ the uAgents library, it's quite simple to get a minimal use case running. Let our first agent be a simple inialisation and printing out the agent's name.
...
**Congratulations, you have just created your first Agent!** We recommend learning about  [interval tasks ↗️](/guides/agents/interval-task) next, then if you want to move really fast going to the [Communicating with other Agents](/guides/agents/communicating-with-other-agents) guide after.
