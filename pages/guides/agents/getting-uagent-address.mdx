...
3. We would then need to assign the μAgent the behavior to be executed. In this case, `alice` could send a message when it is being run saying hello and printing its name and address:
