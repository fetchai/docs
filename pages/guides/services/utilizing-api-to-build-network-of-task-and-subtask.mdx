...
### Generate Regional News Subtask
    ...
    - **Field descriptions** :
        _country_ - describes the country provided by user about which he wants to get news for. This should always be provided by user in all cases. This task responds to generate news subtask always and not News reading system. What is the country you want to know news about? is the question asked to user.
...
### Generate Keyword News Subtask
    ...
    - **Task type**: Subtask.
    - **Protocol** and **Model** will be automatically populated based on the source code of your news reading system agent.
    - **Field descriptions** :
