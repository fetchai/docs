...
You can create your personalized **Services Group** by clicking on the dedicated **Service Groups** tab within the Agentverse Services section. Service Group is just a neat way to package services into one place. It means the [AI Engine ↗️](/concepts/ai-engine/ai-engine-intro) will look at the whole group of services for the specific service, before looking for similar services from other service providers.
