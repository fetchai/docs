...
1. Ensure you have the [Fetch wallet installed](LINK TO FETCH WALLET DOCS) and that the native FETs you want to convert are in this wallet.
2. Ensure you have the [Metamask wallet ↗](Metamask wallet installed) installed and that your Ethereum account is set up on it. This is where the ERC-20 FETs will go to.
...
1. Ensure you have the [Metamask wallet ↗](Metamask wallet installed) installed and that the ERC-20 FETs you want to convert are in this wallet.
2. Ensure you have the [Fetch wallet installed](LINK TO FETCH WALLET HOW TO USE) and that your Fetch.ai account is set up on it. This is where the native FETs will go to.
3. Go to the [Token Bridge ↗](https://token-bridge.fetch.ai/).
4. Unlock the Metamask wallet if instructed to do so.
...
7. Insert your [Fetch wallet address](LINK TO FETCH WALLET DOCS) in the Native Address section.
8. Under **Amount**, enter the amount of tokens you wish to convert.
