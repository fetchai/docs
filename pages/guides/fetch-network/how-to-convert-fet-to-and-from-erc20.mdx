...
## Native to ERC-20 FET
    ...
    1. Ensure you have the [Fetch wallet installed ↗️](/guides/fetch-network/fetch-wallet/web-wallet/get-started) and that the native FETs you want to convert are in this wallet.
...
## ERC-20 to Native FET
    ...
    2. Ensure you have the [Fetch wallet installed ↗️](/guides/fetch-network/fetch-wallet/web-wallet/get-started) and that your Fetch.ai account is set up on it. This is where the native FETs will go to.
    3. Go to the [Token Bridge ↗️](https://token-bridge.fetch.ai/).
    4. Unlock the Metamask wallet if instructed to do so.
