...
1. Ensure you have the [Fetch wallet installed](/guides/fetch-network/fetch-wallet-getting-started.mdx) and that the native FETs you want to convert are in this wallet.
...
2. Ensure you have the [Fetch wallet installed](/guides/fetch-network/fetch-wallet-getting-started.mdx) and that your Fetch.ai account is set up on it. This is where the native FETs will go to.
3. Go to the [Token Bridge ↗](https://token-bridge.fetch.ai/).
4. Unlock the Metamask wallet if instructed to do so.
...
7. Insert your [Fetch wallet address](/guides/fetch-network/how-to-use-the-fetch-wallet.mdx) in the Native Address section.
8. Under **Amount**, enter the amount of tokens you wish to convert.
