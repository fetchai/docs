...
Additional information on different ways to stake FET tokens can be found [here ↗️](/guides/fetch-network/different-ways-to-stake-the-fet-token). Also, checkout the following guides for a better understanding of the staking process both on **Fetch Web** and **Mobile** Wallet:

- [Stake on Fetch Mobile Wallet ↗️](/guides/fetch-network/fetch-wallet/mobile-wallet/stake)
- [Stake on Fetch Web Wallet ↗️](/guides/fetch-network/fetch-wallet/web-wallet/stake)
...
1. First of all, ensure you are logged into your [Fetch wallet ↗️](/guides/fetch-network/fetch-wallet/web-wallet/get-started).
