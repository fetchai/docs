...
2. We then need to create a Cosmostation address for Fetch.ai chain. There exists a [detailed pdf ↗](https://www.cosmostation.io/files/cosmostation_guide_app_en.pdf) from the Cosmostation team explaining how to create an account.
...
Our staking program has moved from Ethereum and we have successfully migrated all the tokens on September 15, 2021 — which you can access on our [Fetch.ai browser wallet ↗](https://chrome.google.com/webstore/detail/fetchai-network-wallet/ellkdbaphhldpeajbepobaecooaoafpg/related).
...
To unstake your tokens, you can use our [guide ↗](/guides/fetch-network/how-to-convert-fet-to-and-from-erc20.mdx) which explains how to convert and send native and ERC-20 FET tokens back to your metamask using the Fetch browser wallet.

![](../../../src/images/staking-images/staking_4.png)

## STAKING/UNSTAKING ON FETCH MAINNET IF YOU HAVE ERC-20 TOKENS ON OTHER EXCHANGES

With the exception of Binance and HitBTC all other exchanges including Coinbase currently hold ERC-20 FET. To stake on Mainnet, you must use our [token bridge ↗](https://token-bridge.fetch.ai/) and metamask.
...
- A Cosmostation Wallet ([iOS ↗](https://apps.apple.com/us/app/cosmostation/id1459830339) and [Android ↗](https://play.google.com/store/apps/details?id=wannabit.io.cosmostaion&hl=en&gl=US)
...
l. Once they have arrived you can delegate them to a validator of your choice. **Congratulations you have successfully staked on Fetch.ai Mainnet 2.0!**
