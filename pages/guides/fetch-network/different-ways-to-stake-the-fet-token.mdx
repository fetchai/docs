...
- For those who staked on **staking.fetch.ai** using ledger — [Here is the guide ↗️](https://fetch.ai/token-migration-guide-for-hardware-wallets/) (refer to Key Migration Desktop)

**IMPORTANTLY, BE SURE TO CREATE YOUR COSMOSTATION ADDRESS ONLY FOR FETCH.AI CHAIN.**

- Official guide from Cosmostation team on how to generate address on Cosmostation Mobile — [pdf ↗️](https://www.cosmostation.io/files/guide_EN.pdf)

- Official guide from Cosmostation team on how to generate address on Cosmostation Web Wallet — [pdf ↗️](https://www.cosmostation.io/files/cosmostation_guide_web_en.pdf)
...
To unstake your tokens, you can use our [guide ↗️](/guides/fetch-network/how-to-convert-fet-to-and-from-erc20.mdx) which explains how to convert and send native and ERC-20 FET tokens back to your metamask using the Fetch browser wallet.
