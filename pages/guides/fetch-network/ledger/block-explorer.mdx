...
The **Ledger Nano** is a hardware wallet designed to provide a secure and convenient way to store and manage cryptocurrencies. It is a physical device, similar in appearance to a USB drive, that is used to securely store the private keys necessary for accessing and managing cryptocurrency holdings.

If you want to log in with your ledger nano device, follow the steps provided below:
...
For networks which support it, you can obtain test tokens by following our dedicated [guide ↗️](/guides/fetch-network/ledger/faucet).
