...
Snapshots are available for both mainnet and the most recent testnet. The URLs for them can be obtained from the [active network ↗️](/references/fetch-network/ledger/active-networks) page of our documentation.
