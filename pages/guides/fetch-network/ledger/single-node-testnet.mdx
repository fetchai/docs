...
5. **Add the validator to the network**: let's now set the initial state for the network, using the following command allocating `100000000000000000000` `stake` tokens to the validator which can be bonded. This is performed with the following command:
