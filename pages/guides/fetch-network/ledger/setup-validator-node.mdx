...
Also, it woould be beneficial if you also explore the [CLI documentation ↗️](/guides/fetch-network/ledger/cli/intro) to understand how to correctly interact with the Fetch Ledger.
