...
**A governance proposal must be submitted to change any attribute of a network**. This could be a simple poll, a software update or a governing parameter change.
