...
Within any decentralised network, any significant change or adjustment should be proposed and subsequently agreed upon by the community or stakeholders involved. This process ensures that decisions are made collectively, helping to maintain transparency, fairness, and the overall integrity of the network.
...
[This documentation ↗️](https://docs.cosmos.network/master/modules/gov/01_concepts.html#proposal-submission) provides a more detailed explanation of the deposit funding period.
