...
Once `fetchd` is configured for the desired [network ↗️](/guides/ledger/cli/intro). The user can query their balance using the following command:
...
Before sending funds, make sure the sender address has tokens available by querying your balance as shown above. Checkout the [Token Faucet](/guides/ledger/faucet) page for more information on how to add test tokens to your address.
