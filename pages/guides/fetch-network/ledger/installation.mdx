...
This would print a version number that must be compatible with the network you are connecting to. See the [network page ↗️](/references/fetch-network/ledger/active-networks) for the list of supported versions per available networks.
