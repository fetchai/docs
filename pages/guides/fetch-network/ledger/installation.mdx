...
This should print a version number that must be compatible with the network you're connecting to. See the [network page ↗️](/references/fetch-network/ledger/active-networks) for the list of supported versions per network.
