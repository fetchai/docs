...
If you wish to **get the list of current proposals** and their corresponding _proposal-ids_, then you need to run the following command:
...
<Callout type="info" emoji="ℹ️">
  When using CLI commands make sure that your CLI is pointing at the correct network. Check the [CLI introduction ↗️](/guides/fetch-network/ledger/cli/intro) in our documentation for more details.
</Callout>
