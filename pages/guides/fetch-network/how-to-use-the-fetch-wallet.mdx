...
3. Press **Send**.
4. In the summary screen, review the details and if everything is correct, select **Approve**. You can check the status of your transaction via the [explorer ↗](https://explore-fetchhub.fetch.ai/).
