...
### How to install ASI web wallet

Install **ASI web wallet** (*version 0.16.0*). The ASI web wallet is supported by all Chromium-based web browsers, including **Chrome**, **Brave**, **Edge**, and **Decentr**. You can install in your Brave and Chrome-based web browser [here ](https://chromewebstore.google.com/detail/fetch-wallet/ellkdbaphhldpeajbepobaecooaoafpg?hl=en-GB).

To install the ASI web wallet, follow these steps:

    1. Open your web browser and go to Google.
    2. Type "ASI web wallet" in the search bar.
...
![](src/images/guides/wallet/getting-started-web-wallet_00.png)
    ...
    4. Click on **Add to Extension** to install ASI web wallet.

![](src/images/guides/wallet/getting-started-web-wallet_01.png)

    5. To use ASI web wallet, click on the ASI web wallet button in your browser. This will redirect you to the ASI web wallet landing page.
...
![](src/images/guides/wallet/getting-started-web-wallet_07.png)
    ...
    4. User is now all set to begin your ASI web wallet journey.
...
If you use the ASI web wallet together with a **Ledger Hardware Wallet** and want to retain your key and mnemonics there, then:
