...
Some of its highlights include:
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout our [GitHub repository ↗️](https://github.com/fetchai/fetch-wallet) for the Fetch wallet to improve your knowledge or get yourself started with our [Fetch wallet guides ↗️](/guides#fetch-wallet).
    </Callout>
