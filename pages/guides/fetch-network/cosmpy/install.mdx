...
Welcome to CosmPy, the Python-based library that will streamline your interactions with Cosmos SDK based blockchain networks.
...
Once correctly installed you should see the following output on the terminal
