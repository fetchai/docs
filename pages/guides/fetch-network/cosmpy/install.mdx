...
For more information on CosmPy, visit our dedicated [GitHub ↗️](https://github.com/fetchai/cosmpy) repository.
    ...
    <Callout type="info" emoji="ℹ️">
      If you want to improve your knowledge, please visit our [GitHub repository ↗️](https://github.com/fetchai/cosmpy) for CosmPy or checkout our dedicated [CosmPy guides ↗️](/guides#cosmpy).
    </Callout>
