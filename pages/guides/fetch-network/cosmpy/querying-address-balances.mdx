...
Once you have established a [connection to a network node ↗️](/guides/fetch-network/cosmpy/establishing-node-connection.mdx), you can use the `LegderClient` object to perform many useful operations, such as _querying balances_. In particular the `LedgerClient` object allows you to:
