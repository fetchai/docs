...
1. First of all, create a Python script and name it: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > aerial_oracle.py`,
        mac: `touch aerial_oracle.py`,
        ubuntu: `touch aerial_oracle.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
1. Let's first create a Python script and name it:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > aerial_oracle_client.py`,
        mac: `touch aerial_oracle_client.py`,
        ubuntu: `touch aerial_oracle_client.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
