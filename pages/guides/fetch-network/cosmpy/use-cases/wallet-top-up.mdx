...
1. Let's start by creating a Python script for this:
    ...
    <CustomPre 
        commands={{
        windows: `echo. > aerial_authz.py`,
        mac: `touch aerial_authz.py`,
        ubuntu: `touch aerial_authz.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
...
1. Let's create a Python script for this and name it: 
    ...
    <CustomPre 
        commands={{
        windows: `echo. > aerial_topup.py`,
        mac: `touch aerial_topup.py`,
        ubuntu: `touch aerial_topup.py`
        }} 
        dataLanguage="bash"
        hasCopyCode={true}
        osMenu={true}
