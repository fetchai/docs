...
Once you haveve executed the script you will notice the console output is consistent with the code. We first see a print of the starting balance of both addresses, we then see the transaction hash along with the new balances for boch Alice and Bob:
