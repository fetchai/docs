...
If you wish to access other key functionalities, including _adding new keys_, _looking up an address_, and _recovering keys_, you can use [fetchd CLI - Managing Keys ↗️](/guides/fetch-network/ledger/cli/keys).
