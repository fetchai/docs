...
To reproduce the examples provided here, we need to add and compile a basic starter contract and a cw20 token contract to your project with the following commands:
...
For more contract template examples visit [Jenesis Templates ↗️](https://github.com/fetchai/jenesis-templates)
