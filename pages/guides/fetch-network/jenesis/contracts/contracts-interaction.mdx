...
Contract Interaction in blockchain refers to the process of communicating with deployed smart contracts. This involves querying contract information or executing specific functions defined within the contract. Interactions can include tasks like checking balances, transferring tokens, and more. Profiles provide network and contract configurations, while dynamic methods simplify common tasks. Scripts automate interactions for programmatic tasks. This interaction is vital for utilizing decentralized applications and services offered by smart contracts on the blockchain.
...
To reproduce the examples provided here, we need to add and compile a basic [starter ↗️](https://github.com/fetchai/jenesis-templates/tree/master/contracts/starter) contract and a [cw-20 token contract ↗️](https://github.com/fetchai/jenesis-templates/tree/master/contracts/cw20-base) to your project with the following commands:
...
Additionally, Jensesis has an autocompletion helper for query, execution and deployment arguments. It will show automatically when typing in the shell.
...
We now execute a cw-20 token transfer of 1000 tokens from wallet to wallet2:
