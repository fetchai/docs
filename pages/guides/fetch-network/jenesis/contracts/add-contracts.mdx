...
You first need to navigate to your project's directory and run the following command:

    ```
    jenesis add contract <template> <contract_name>
    ```

You can find all the contract templates available in [Jenesis Templates ↗️](https://github.com/fetchai/jenesis-templates).
...
To add a deployment to your project, you can run:
