...
2. **OpenAI API Key**
   ...
   \_Note that if you have run out of OpenAI credits, you will not be able to get results for this example.\_\_
...
To use the environment variables from `.env` and install the project:
    ...
    ```
        ...
        <Callout type="info" emoji="ℹ️">
          Checkout our [GitHub repository ↗️](https://github.com/fetchai/uAgents/tree/main/integrations/fetch-holiday) for the AI Agents Holiday Integrations to get yourself started and checkout the [dedicated guide ↗️](/guides/integrations/fetch-holiday/walk-through) we created to help you understand how to proceed with this integration.
        </Callout>
