...
We can now start defining our agents and messages data model.
        ...
        <Callout type="info" emoji="ℹ️">
          Checkout our [GitHub repository ↗️](https://github.com/fetchai/uAgents/tree/main/integrations/mobility-integrations) for the AI Agents mobility integrations to get yourself started and checkout the [dedicated guide ↗️](/guides/integrations/fetch-mobility/walk-through) to help you understand how to proceed with this integration.
        </Callout>
