...
Go to the [AgentVerse ↗️](https://agentverse.ai/services) and create new Agent Function for all three agents created [above ↗️](/guides/agentverse/huggingface-text-classification-model-agent#setting-up-agents). You can do so within the **My Agents** tab, by clicking on desired agent and accessing its information. Here, you will need to click on the **Deploy** tab and provide all needed details required for successful Agent Function registration.
...
![](../../../src/images/guides/services/service-guide/hugging_face_1.png)
    ...
    - **Description**: super important to be as detailed as you can, as reasoning AI Engine looks at descriptions to understand what your Agent Function does - in this example we can specify something like this: **This Fucntion helps user to give any query to the selected model and gets the response to their query. Always go for hugging face request secondary function for this primary function.**
...
![](../../../src/images/guides/services/service-guide/hugging_face_2.png)
    ...
    - **Application**: Secondary Fucntion.
