...
Build fast and lightweight AI Agents for decentralized scenarios using the `uagents` Framework. Checkout the [AI Agents ↗️](/concepts/agents/agents) documentation and the [`uagents` package ↗️](https://pypi.org/project/uagents/) for more information.
