...
- `uagents`: build fast and lightweight agents for decentralized scenarios using the uAgents framework. Checkout the [AI Agents ↗️](/concepts#ai-agents) documentation for more information.
