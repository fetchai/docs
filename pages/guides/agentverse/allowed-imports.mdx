...
- **Uagents:** Build fast and lightweight agents for decentralized scenarios using the μAgents (micro-Agents) framework. Checkout [micro agents](https://docs.fetch.ai/uAgents/ ) documentation for more information.
...
- **Cosmpy:** A Python library for interacting with Cosmos-based blockchains. Checkout [cosmpy](https://docs.fetch.ai/CosmPy/ ) documentation for more information.
...
You can create a message.py file with the following Model:
```python
...
Then you can just importe the `Sentence` Model to your agent.py file and make use of it.
...
Explore the rest of the [Agentverse](https://agentverse.ai/) documentation for more guides and resources!
