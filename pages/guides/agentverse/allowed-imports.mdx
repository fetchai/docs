...
Build fast and lightweight Agents for decentralized scenarios using the `uagents` Framework. Checkout the [Agents ↗](/concepts/agents/agents) documentation and the [`uagents` package ↗️](https://pypi.org/project/uagents/) for more information.
