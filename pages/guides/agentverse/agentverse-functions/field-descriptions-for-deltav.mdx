...
This Function helps user to find local businesses in any locality and specified category. This uAgent Function returns list of 10 businesses to user and gives information about selected business by the user.
...
## uAgent Functions registration examples

For additional information and guidelines on how to register an uAgent Function on the Agentverse and examples of descriptions, head over to our dedicated resources:
   ...
   - [Register a coin toss uAgent as a Function ↗️](/guides/agentverse/registering-agent-coin-toss).
