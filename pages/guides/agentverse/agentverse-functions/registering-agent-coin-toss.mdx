...
<GithubCodeSegment digest="10d78ecdd8c62fe5edbd30f167f1a6b0">
    <CodeSegment
...
<CodeGroup dynamic hasCopy isLocalHostedFile digest='10d78ecdd8c62fe5edbd30f167f1a6b0'>
...
Similar to this [guide ↗️](/guides/agentverse/agentverse-functions/registering-agent-services#register-your-agents-and-services), let's navigate to the [Agentverse: My Agents ↗️](https://agentverse.ai/) tab. Here, click on your Agent to show the Agent Editor and then click on the **Deploy** tab to start registering your Agent function.
