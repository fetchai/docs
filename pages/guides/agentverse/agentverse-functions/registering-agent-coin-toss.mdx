...
# Agentverse Functions: register a coin toss uAgent as a Function

## Introduction

In the [Agentverse Functions: register your Functions on the Agentverse! ↗️](/guides/agentverse/registering-agent-services) guide, you have gotten familiar with the creation of an uAgent that can be registered as a Function and then be used in [DeltaV ↗️](/concepts/ai-engine/deltav).

    <Callout type="info" emoji="ℹ️">
      Check out the [Functions ↗️](/guides/agents/intermediate/agent-functions) guide for additional information needed for uAgent Functions and their registration on the Agentverse and Fetch network.
    </Callout>
...
A new uAgent will be created for you:

![](src/images/guides/agentverse/registering-agent-coin-toss/hosted-agent-in-list.png)

## Run your coin toss uAgent!

After clicking on the row of your newly created uAgent, you should be able to see the source code of your coin toss uAgent in the editor view:

    ```python copy filename="agent.py"
    # Here we demonstrate how we can create a simple coin toss uAgent that is compatible with DeltaV.
...
Now click on the **Run** button in the upper right corner of the editor so that you have your coin toss uAgent up and running!

![](src/images/guides/agentverse/registering-agent-coin-toss/run-hosted-agent.png)

## Register your coin toss agent function!

Similar to this [guide ↗️](/guides/agentverse/agentverse-functions/registering-agent-services#register-your-agents-and-services), let's navigate to the [Agentverse: My Agents ↗️](https://agentverse.ai/) tab. Here, click on your uAgent to show the Agent Editor and then click on the **Deploy** tab to start registering your uAgent function.
...
![](src/images/guides/agentverse/registering-agent-coin-toss/new-service-dialog.png)
    ...
    - **Function title**: just the name of your uAgent Function. In this example let's call it **Coin toss function**
    ...
    - **Application**, **Protocol**, **Model** and **Field descriptions** will be automatically populated based on the source code of [your coin toss uAgent ↗️](/guides/agentverse/agentverse-functions/registering-agent-coin-toss#run-your-coin-toss-agent)
...
As your objective task (`Toss a coin`) specified on the previous screen contained words related to the [description of your coin toss uAgent ↗️](/guides/agentverse/agentverse-functions/registering-agent-coin-toss#run-your-coin-toss-agent), your Coin Toss Function is listed as an option.
