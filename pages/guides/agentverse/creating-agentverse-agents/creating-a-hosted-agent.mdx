...
Check out the following [guide ↗️](/guides/agents/intermediate/mailbox) if you have a [local Agent ↗️](/guides/agents/intermediate/agent-types#local-agents) which you want to onboard the Agentverse via a Mailbox. The guide will help in understanding how to enroll the Agent using a Mailbox, and how to possibly set up a README file locally and then publish it on Agentverse for your local Agent.
