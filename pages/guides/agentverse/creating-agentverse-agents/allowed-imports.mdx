...
In the [Agentverse ↗️](https://agentverse.ai/) code editor, you have the freedom to import and utilize a selected set of modules to create your code, while maintaining security and control. These pre-approved modules offer a diverse range of functionalities, allowing you to build complex uAgents.
...
For additional information on Functions, head over to [uAgent Functions ↗️](/guides/agents/intermediate/agent-functions) and [Register uAgent Functions ↗️](/guides/agentverse/agentverse-functions/registering-agent-services).
