...
![](../../../src/images/agentverse/explorer/agentverse_agent_profile_chart.png)
...
For additional information, visit the [Agents protocols ↗️](/references/uagents/uagents-protocols/agent-protocols) documentation and the [How to book a table at a restaurant using agents ↗️](/guides/agents/booking-demo), [How to use the agents to simulate a cleaning scenario ✨ ↗️](/guides/agents/cleaning-demo), and the [Agents: broadcast 📡 ↗️](/guides/agents/broadcast) guides for a better understanding of what a protocol is and how to code it correctly and retrieve it in your scripts.
