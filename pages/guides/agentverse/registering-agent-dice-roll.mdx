...
In the [Agentverse Services: register a coin toss agent as a service 🪙 ↗️](/guides/agentverse/registering-agent-coin-toss) you have gotten familiar with the creation of a coin toss agent that can be registered as a service and then can be used in DeltaV.
