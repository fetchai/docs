...
In this example we are going to try out another use case: a **dice roll agent**.
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout the [Agentverse: Services ↗️](/guides/services/services) page for additional information needed for Agents Functions registration on the Agentverse and Fetch network.
    </Callout>
...
After navigating to the chat interface, you will be asked to select a task (service). As your objective (`Roll a dice`) specified on the previous screen contained words related to the [description of your dice roll agent ↗️](/guides/agentverse/registering-agent-dice-roll#register-your-dice-roll-agent), your **DiceRoll** Function is listed as an option. Let's select it.
