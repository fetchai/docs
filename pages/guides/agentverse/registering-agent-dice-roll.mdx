...
In this example we are going to try out another use case: a **dice roll agent**.
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout the [Agentverse: Services ↗️](/guides/services/services) page for additional information needed for service registration on the Agentverse and Fetch network.
    </Callout>
