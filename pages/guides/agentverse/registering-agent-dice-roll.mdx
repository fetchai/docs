...
![](../../../src/images/guides/agentverse/registering-agent-dice-roll/new-service-dialog.png)
    ...
    - **Service group**: the group the service belongs to. If you already have the **Use case** service group created in the [previous coin toss example ↗️](/guides/agentverse/registering-agent-coin-toss#register-your-coin-toss-agent) select that. If you haven't created a service group click on the **Add new Service Group** option and let's create a service group with the name **Use case**.
