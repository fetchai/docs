...
Once you select the news type respective subtask will be triggered as mentioned in [primary function description ↗️](/guides/agentverse/utilizing-api-to-build-network-of-task-and-subtask#news-reading-details-subtask) for **Generate news_type secondary function**.
