...
**Field description** is another feature of services which should mention use of secondary functions in a clear and concise way. Refer to the [Agentverse Functions ↗️](/guides/services/services) resource for more details on both primary and secondary functions.
...
### News Reading URL System
    ...
    - **Description**: super important to be as detailed as you can, as reasoning engine looks at descriptions to understand what your Agent Function does; in this example we can specify something like "**Always go for secondary function with ID **news reading details** secondary function. The service provides news clickable hyperlink user wants to read according to their choice.**".
...
### News Reading Details Secondary Function
    ...
    - **Description**: super important to be as detailed as you can, as reasoning engine looks at descriptions to understand what your Agent Function does; in this example we can specify something like "**This service takes different details for news reading from user. This is triggered always after News Reading url system.**
...
Once you select the news type respective subtask will be triggered as mentioned in [priimary function description ↗️](/guides/agentverse/utilizing-api-to-build-network-of-task-and-subtask#news-reading-details-subtask) for **Generate news_type secondary function**.
