...
To create a Mailbox, first of all, set up your local Agent. Then, run it and click on the [local Agent Inspector](/guides/agents/intermediate/local-agent-inspector) URL provided within your terminal output. You will be redirected towards the Inspector UI. Here, you will be able to see multiple details about your local Agent. To connect the local Agent with a Mailbox, click the **Connect** button.
