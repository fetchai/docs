...
You can also checkout the following [guide ↗️](/examples/intermediate/local-agent-langchain) for an additional representation of how to set up a mailbox for an agent using the Agentverse within your Agent's code.
