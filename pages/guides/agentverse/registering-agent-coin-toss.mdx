...
In the [Agentverse: Services ↗️](/guides/agentverse/registering-agent-services) guide, you have gotten familiar with the creation of an agent that that can be registered as a service and then be used in DeltaV.
