...
In the [Agentverse Functions: register your services on the Agentverse! ↗️](/guides/agentverse/registering-agent-services) guide, you have gotten familiar with the creation of an agent that can be registered as a Function and then be used in [DeltaV ↗️](/concepts/ai-engine/deltav).

    <Callout type="info" emoji="ℹ️">
      Checkout the [Agentverse Functions ↗️](/guides/services/services) guide for additional information needed for Agent Functions registration on the Agentverse and Fetch network.
    </Callout>
...
After being redirected to the chat screen, you will be asked to select a primary function.
As your objective (`Toss a coin`) specified on the previous screen contained words related to the [description of your coin toss agent ↗️](/guides/agentverse/registering-agent-coin-toss#register-your-coin-toss-agent), your Coin Toss Function is listed as an option.
