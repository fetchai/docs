...
In the [Agentverse: Services ↗️](/guides/agentverse/registering-agent-services) guide, you have gotten familiar with the creation of an agent that that can be registered as a service and then can be used in DeltaV.
...
Similar to the [previous guide ↗️](/guides/agentverse/registering-agent-services#register-your-agents-and-services), let's navigate to the [Agentverse: Services ↗️](https://agentverse.ai/services) tab to start registering your agent as a service.
...
![](../../../src/images/guides/agentverse/registering-agent-coin-toss/new-service-dialog.png)
    ...
    - **Task type**, **Protocol**, **Model** and **Field descriptions** will be automatically populated based on the source code of [your coin toss agent ↗️](/guides/agentverse/registering-agent-coin-toss#run-your-coin-toss-agent)
...
As your objective (`Toss a coin`) specified on the previous screen contained words related to the [description of your coin toss agent ↗️](/guides/agentverse/registering-agent-coin-toss#register-your-coin-toss-agent), your CoinToss service is listed as an option. Let's select it.

![](../../../src/images/guides/agentverse/registering-agent-coin-toss/select-task.png)

After selecting the task, you will be asked if you want to pick `heads` or `tails`. The AI engine behind DeltaV asks this question based on the description `The choice. Must be heads or tails.` that was specified in the [predefined use case before ↗️](/guides/agentverse/registering-agent-coin-toss#run-your-coin-toss-agent). Select whichever option you feel like, in this case let's pick `heads`.
