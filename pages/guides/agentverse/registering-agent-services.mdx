...
First, you need to head over to the [Agentverse ↗️](https://agentverse.ai/) and log in. Then head towards the [Agentverse ↗️](https://agentverse.ai/) and choose the **Services** tab to start registering your agent as a service. You will see a page like this:
...
As said in agentverse, a service group is just a neat way to package these services into one place. It means the [AI Engine ↗️](pages/concepts/ai-engine/ai-engine-intro) will look at the whole service group for services, before looking for similar services from over service providers.
