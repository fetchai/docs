...
![](../../../src/images/guides/agentverse/deltav_full_zero.png)
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout our additional guide [Create and register a service on DeltaV 🌐 ↗️](/guides/deltav/create-and-get-a-service-on-deltav) for an additional resource on how to register your agent as a service and retrieve it within DeltaV.
    </Callout>
