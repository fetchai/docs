...
Given such input, the AI Engine will start working on such a task and consequently will start looking for Agents providing information about nearby airports available based on latitude and longitude parameters according to your location.
