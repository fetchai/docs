...
[DeltaV ↗️](https://deltav.agentverse.ai/login) chat interface presents multiple features. When landing on [DeltaV ↗️](/concepts/ai-engine/deltav), you will first be required to log in providing your details. Once you do so, you will be prompted towards the **Start your Session** page where you will be able to enter your queries.
    ...
    <Callout type="info" emoji="ℹ️">
      If you enable **Advanced Options**, you will be able to define the **Function Groups** for the query you are looking for, and the style/personality of the language model used to provide answers to your queries. You can choose among the following options:
...
As soon as you enter the type of function you wish to assemble, you will be directed towards the actual DeltaV chat interface. Here, you will interact with DeltaV chat agent. In the **top right corner** of the chat interface, we have different **buttons**:
...
Now that we have covered all essential pieces of the DeltaV chat interface, **we are ready to start our first service query!**
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout the [Assemble any Function with DeltaV! ↗️](/guides/deltav/book-service-with-deltav) guide to get started with your first function query using this platform!
