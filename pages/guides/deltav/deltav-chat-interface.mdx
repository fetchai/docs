...
In the **top right corner** of the chat interface, we have **4 buttons**:
...
![](../../../src/images/deltav/getting-started/deltav_chat_interface_buttons.png)
    ...
    - **Connect your service button**: this redirects you to the [Agentverse ↗️](/concepts/agent-services/agentverse-intro) so to register any service you wish to make available on the DeltaV platform for users to start querying for it. It is possible to wrap up services thanks to [AI Agents ↗️](/concepts/agents/agents) technology.
    ...
    - **AI Personality button**: this one allows you to set the style/personality of the language model used to provide answers to your queries. You can choose among the following options:
            ...
            - **Thoughtful** mode: this is the most powerful model which can be set to answer your queries. It does the best job but it is still under development and will be available soon.
...
Now that we have covered all essential pieces of the DeltaV chat interface, **we are ready to start our first service query!**
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout our [guides for using DeltaV ↗️](/guides#deltav) to get yourself started!
    </Callout>
