...
DeltaV chat interface presents multiple features. When landing on [DeltaV ↗️](https://deltav.agentverse.ai/login), you will first be required to log in providing your details. Once you do so, you will be prompted towards the **Start your Session** page where you will be able to enter your queries.
...
![](../../../src/images/guides/deltav/getting-started/deltav_chat_interface_buttons.png)
    ...
    - **Connect your Service button**: by clicking on this, you will be redirected towards the [Agentverse ↗️](/concepts/agent-services/agentverse-intro) so for you to register any service you may wish to make visible via DeltaV chat interface. This provides an innovative way of monetize your services and get the most out of those! For additional information, Checkout the dedicated guide to [Registering agent services on the Agentverse ↗️](/guides/agentverse/registering-agent-services) which illustrates the process of enrolling your service in a straightforward way via the **Agentverse: Services** tab and subsequently DeltaV. For additional resources, have a look at the following guides: [Register a coin toss agent as a service ↗️](/guides/agentverse/registering-agent-coin-toss) and [Register a dice roll agent as a service ↗️](/guides/agentverse/registering-agent-dice-roll).
...
Now that we have covered all essential pieces of the DeltaV chat interface, **we are ready to start our first service query!**
    ...
    <Callout type="info" emoji="ℹ️">
      Checkout the [Book any service with DeltaV! ↗️](/guides/deltav/book-service-with-deltav) guide to get started with your first service booking using this revolutionary platform!
    </Callout>
