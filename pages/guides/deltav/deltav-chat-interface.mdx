...
![](../../../src/images/deltav/getting-started/deltav_chat_interface_buttons.png)
    ...
    - **Profile button**: here you will find information about your _USED CREDIT_ amount. This is the amount of credit you spent interacting with the [AI Engine ↗️](/concepts/ai-engine/ai-engine-intro) and LLMs. The cost depends on the AI personality used. The more complex the personality, the higher the credit usage. If you run out of credit you can always request more. In here, you will also find the _Log out_ option.
