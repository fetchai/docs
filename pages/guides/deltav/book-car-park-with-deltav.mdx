...
It is possible to use DeltaV to request a car parking spot service located in the area close to your current location. This can be done directly thanks to DeltaV AI Agent.
...
In this guide, we need a car park service to park safely our car. Thus, type **I need a parking spot** into the chat's interface.
