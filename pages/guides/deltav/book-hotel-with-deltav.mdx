...
DeltaV's AI Agent is at your service, ready to assist you promptly at any step during your booking process! Indeed, DeltaV AI-powered chat interface allows you to simply book a hotel according to your needs and desires in a straightforward way. As an initial step, once you have [logged in ↗️](/guides/deltav/deltav-chat-interface), you will be asked to query for a type of service by DeltaV AI Agent. Let's assume that you successfully [booked a flight ↗️](/guides/deltav/book-flight-with-deltav) to the city of Dubai using DeltaV, and that now you need to look for an accommodation for your stay. This can also be done via DeltaV in the following way.

In our scenario, let's assume we are looking for a hotel accommodation. Thus, type **Book a hotel in Dubai** into the chat's interface. This will start the [AI Engine ↗️](/concepts/ai-engine/ai-engine-intro) which will figure out the task related to your request and objective. This task will be based on such latter information and the Engine will find all available [AI Agents ↗️](/concepts/agents/agents) registered within the [Agentverse ↗️](/concepts/agent-services/agentverse-intro) platform offering services akin to your request.
