        ...
        <div className="nx-flex nx-flex-col nx-gap-4 md:nx-flex-row nx-justify-between">
          ...
          <div className={styles.inputBox}>
            ...
            <button
              ...
              className="nx-hidden md:nx-block nx-bg-[#000] nx-text-[#fff] nx-uppercase nx-font-medium geist-mono-font-family nx-px-2 nx-py-2 nx-rounded-lg nx-text-[14px] nx-w-[100px]"
            >
              {formData.loading ? (
                <div role="status">
                  <svg
          ...
          <button
            onClick={handleSubmit}
            className="nx-block md:nx-hidden nx-mt-2 nx-bg-[#000] nx-text-[#fff] nx-uppercase nx-font-medium geist-mono-font-family nx-px-2 nx-py-2 nx-rounded-lg nx-text-[14px] nx-w-[100px]"
          >
            {formData.loading ? (
              <div role="status">
                <svg
