...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={`nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]`}
    >
      <section className={styles.page}>
        <div className="nx-relative nx-px-6 md:nx-px-0 lg:nx-container xs:nx-mx-0 md:nx-mx-auto">
          <div className="nx-grid nx-items-start nx-grid-cols-1 sm:nx-grid-cols-3 sm:nx-gap-8">
            ...
            <div className="nx-col-span-2 sm:nx-m-0 md:nx-mx-auto ">
              <div className="nx-auto-cols-auto-auto nx-grid geist-mono-font-family nx-leading-[160%] nx-text-sm nx-uppercase nx-font-medium nx-text-[#000D3D] nx-gap-6 xs:nx-grid-cols-2 md:nx-grid-cols-2 md:nx-grid-rows-1 md:nx-gap-[88px]">
                <div className="nx-items-star nx-inline-flex nx-flex-col nx-gap-[12px] xs:nx-order-2 md:nx-order-2 lg:nx-items-start">
                  <Link
                ...
                <div className="nx-z-1 nx-inline-flex nx-flex-col nx-items-start nx-gap-[12px] xs:nx-order-2 md:nx-order-3">
                  <Link
                    className="nx-block hover:nx-underline"
                    id="footer_github"
