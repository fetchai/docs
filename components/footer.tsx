        ...
        <footer className={styles.page}>
            <div className={styles.footerPage}>
                <div className="nx-container nx-mx-auto">
                    <div
                        className="nx-grid nx-grid-cols-1 sm:nx-grid-cols-1 md:nx-grid-cols-4 lg:nx-grid-cols-4 nx-gap-4">
                        <div className="md:nx-col-span-2 nx-mb-8 md:nx-mb-0">
                            <Image
                                src={logo}
                                alt="Logo"
                            />
                            <p className="nx-text-gray-600 nx-text-sm nx-mt-8 nx-footer-width-50"> Creating AI platforms
                                and services that let anyone build and deploy AI services at scale, anytime and
                                anywhere.</p>
                        ...
                        <div className="md:nx-col-span-2 nx-mb-8 md:nx-mb-0">
                            <div
                                className="nx-grid nx-grid-cols-2 sm:nx-grid-cols-2 md:nx-grid-cols-4 lg:nx-grid-cols-4 nx-gap-4">
