  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination:
          "/examples/dialogues/open-dialogue-chitchat",
        permanent: true,
      },
      {
        source: "/examples/advanced/predefined-dialogue-chitchat",
        destination:
          "/examples/dialogues/predefined-dialogue-chitchat",
        permanent: true,
      },
      {
        source: "/examples/advanced/async-loops",
        destination:
          "/examples/agent/async-loops",
        permanent: true,
      },
      {
        source: "/examples/advanced/chat_api_example",
        destination:
          "/examples/ai-engine-api/chat_api_example",
        permanent: true,
      },
      {
        source: "/examples/advanced/deltaV-dialogues",
        destination:
          "/examples/dialogues/deltaV-dialogues",
        permanent: true,
      },
      {
        source: "/examples/postgres-database-with-an-agent",
        destination:
          "/examples/examplestech/postgres-database-with-an-agent",
        permanent: true,
      },
      {
        source: "/examples/react-example",
        destination:
          "/examples/examplestech/react-example",
        permanent: true,
      },
      {
        source: "/examples/hugging-face-agent",
        destination:
          "/examples/examplestech/hugging-face-agent",
        permanent: true,
      },
      {
        source: "/examples/jupyter-agent",
        destination:
          "/examples/examplestech/jupyter-agent",
        permanent: true,
      },
    ];
  },
