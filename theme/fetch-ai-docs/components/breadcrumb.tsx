...
export function Breadcrumb({
  ...
  return (
    <div className="nextra-breadcrumb nx-mt-1.5 nx-flex nx-items-center nx-gap-1 nx-overflow-hidden nx-text-sm nx-text-gray-500 dark:nx-text-white-60 contrast-more:nx-text-current">
